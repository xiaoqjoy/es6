...
export default {
  ...
  methods: {
    ...
    //   res = res || {};
    //   current = current || 1;
    //   let url = checkingApi.LoanSearchk + "?current=" + current + "&size=10";
    //   this.$MyFetch
    //     .post(url, res)
    //     .then((data = {}) => {
    ...
    // // 查询
    // refer() {
    //   this.searchData.eq.bill_no = this.batchNumberIntroduced;
