      ...
      <div class="dialog-box__content">
        ...
        <div class="dialog-box_info">
          <div class="info_item">
            ...
            <i class="item_data">{{ChannelList.loanNo}}</i>
          </div>
          <div class="info_item">
        ...
        <el-form v-if="name=='sponsorDetail'" :model="ChannelObj" :rules="rules3" ref="ChannelObj">
          ...
          <div class="select_item">
              <el-button :disabled="adjustDate?false:true" class="print_t button" @click="countFun">计算</el-button>
          </div>
        </el-form>
        <!-- 表格 -->
        <div class="tableBox">
            ...
            <div class="tableBody">
              <el-form :model="writeInfo" :rules="rules" ref="writeInfo">
                <div class="tableBodyTr">
                  ...
                  <div class="tableBodyTd2"><span class="spanStyle1">{{ChannelList.payFine}}</span></div>
                  <div class="tableBodyTd3"><span class="spanStyle1">{{ChannelList.actualFine}}</span></div>
                ...
                <div class="tableBodyTr">
                  ...
                  <div class="tableBodyTd2"><span class="spanStyle1">{{ChannelList.payCompound}}</span></div>
                  <div class="tableBodyTd3"><span class="spanStyle1">{{ChannelList.actualCompound}}</span></div>
                  <div class="tableBodyTd4">
...
export default {
  ...
  methods: {
    ...
    countFun() {
      ...
      let queryData = {
        loanNo: this.ChannelList.loanNo,
        sterm: this.ChannelList.sterm,
      ...
      let _this = this;
       this.$refs.writeInfo.validate((valid) => {
         if (valid) {
          ...
          //  }
             let queryData = {
               loanNo: _this.ChannelList.loanNo,
               sterm: _this.ChannelList.sterm,
               payDate: _this.ChannelList.payDate,
               adjustDate: _this.adjustDate,
               payFine: _this.ChannelList.payFine,
               adjustFine: _this.writeInfo.adjustPayFine,
               payCompound: _this.ChannelList.payCompound,
               adjustCompound: _this.writeInfo.adjustPayCompound,
               flowNo: "intFineFlow",
               actualFine: _this.ChannelList.actualFine, // 减免罚息
               actualCompound: _this.ChannelList.actualCompound, // 减免复利
               transSerialNo: _this.transSerialNo, // 总单号
               transType: this.transType
             };
    ...
    // 编辑列表
    ChannelListApi(res) {
      this.$MyFetch.post(counterDealApi.batchPayInteFineAdjustEditor, {
        transSerialNo: this.transSerialNo,
        transType: this.transType
      })
      .then((data = {}) => {
          this.ChannelList = data.records[0];
          this.writeInfo.adjustPayCompound = data.records[0].adjustCompound;
          this.writeInfo.adjustPayFine = data.records[0].adjustFine;
          this.adjustDate = data.records[0].payDate;
          })
      .catch((err) => {
          this.$error(err.message);
      });
