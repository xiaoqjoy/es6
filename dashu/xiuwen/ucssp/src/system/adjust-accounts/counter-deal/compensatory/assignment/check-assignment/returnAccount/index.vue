  ...
  <div class="import-message">
    ...
    <div class="dialog-box">
      ...
      <div class="affirm_select">
        ...
        <el-button class="t_button affirm_t button" @click="save">确认</el-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  methods: {
    delete_close() {
      this.$emit("close_account");
    },
    save() {
      if (this.message === "是否确定退回选中的记录") {
        this.returnInterface();
      } else {
        this.submitInterface();
      }
    }
  },
  props: ["returnInterface", "message", "submitInterface"]
};
</script>
