  ...
  <div class="import-message">
    ...
    <div class="dialog-box">
      ...
      <div class="text__center">
        <el-button type="primary" @click="submit_fun">保存</el-button>
      </div>
    </div>
