      ...
      <div class="complete-product">
        <div class="dialog-box__middle-form">
          <div class="dial_cent">
            ...
            <input class="file"  type="file" @change="tirggerFile" ref="file" />
...
<script type="text/ecmascript-6">
  ...
  import { checkingApi } from "@/system/adjust-accounts/js/server"; // 接口
  ...
  export default{
    ...
    methods: {
      ...
      finish() {
        ...
        console.log(this.filePostfix, 'this.filePostfix------');
        let fileIds = '';
        if (!this.hint) {
          // 把文件名传给负组件
