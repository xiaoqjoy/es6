          ...
          for (var j = 0; j < this.filePostfix.length; j++) {
            ...
            axios({
              ...
              var obj = {
                ...
                ExpiredTime: res.data.data.credentials.expiredTime
              };
              fileIds = res.data.data.fileInfo.fileId;
              console.log(res, obj, fileIds, "res");
              let _filePath = res.data.data.fileInfo.filePath;
              var cos = new COS({
