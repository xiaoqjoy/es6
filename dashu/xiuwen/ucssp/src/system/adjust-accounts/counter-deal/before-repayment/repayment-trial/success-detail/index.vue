      ...
      <div class="complete-product">
        <div class="dialog-box__middle-form">
            ...
            <!-- <div class="form__bottom">
              <el-button class="add look_info button " type="primary" @click="look_info()">查看贷款信息</el-button>
...
export default {
  ...
  methods: {
    // 开始试算接口
    prepaymentTrial(res) {
      this.$MyFetch.post(counterDealApi.prepaymentTrial, res)
        .then((data = {}) => {
            this.trialInfo = data;
        })
        .catch((err) => {
    ...
    trialStart() {
      ...
      if (!(this.tally_date)) {
        this.simplenessHintData = '选择预计结清日期！';
        this.simplenessHintFlag = true;
      } else {
        // 开始试算接口
        let trialData = {
          loan_no: this.tetailData.loanNo,
          estimated_payoff_date: this.tally_date
        };
        this.prepaymentTrial(trialData);
      }
    },
    // 子传父 引入传来的交易号
    trialData(data) {
