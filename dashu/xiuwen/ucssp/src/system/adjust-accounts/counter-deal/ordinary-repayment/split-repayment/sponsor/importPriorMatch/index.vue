          ...
          <!-- 内容区 -->
            <div class="form__block bg__white border__radius-5" >
              ...
              <div class="b_content">
                ...
                <!-- <el-input class="select_72" v-model="repayment_num" placeholder="还款期次"></el-input>
                <el-date-picker
                  v-model="value1"
                  class="select_7"
                  type="date"
...
export default {
  ...
  mounted() {
      // this.SplitRepaymentLists();
  },
  methods: {
    // 一般还款应还的还款计划查询  -- 引入接口
    SplitRepaymentLists(res, current) {
      res = res || {
        "phase_no": "0010",
      ...
      let url = counterDealApi.SplitRepaymentLists + "?current=" + current + "&size=10";
      console.log(url, 'url');
    ...
    jump(pageNum) {
      ...
      this.SplitRepaymentLists(this.queryData, pageNum);
    },
    ...
    search_refer() {
      ...
      // 一般还款应还的还款计划查询接口
      this.SplitRepaymentLists(this.queryData);
    },
    // 关闭弹窗
    close() {
