...
export default {
  ...
  created() {
    ...
    this.boundsTransferDetail(queryData);
  },
  methods: {
    // 批量单笔明细
    boundsTransferDetail(res, current) {
        res = res || {};
        current = current || 1;
        let url = counterDealApi.boundsTransferDetail + "?current=" + current + "&size=10";
    ...
    this.boundsTransferDetail(queryData, current);
    }
  },
  components: {
    pagination
