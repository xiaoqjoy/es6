      ...
      <div class="complete-product">
        <div class="dialog-box__middle-form">
            ...
            <div class="form__block bg__white border__radius-5">
              <div class="dialog-box__form__group">
                <div class="user">
                  ...
                  <label class="username">二级编号：</label>
                  <span v-html="list_.codeLevelTwo"></span>
                  <label class="username">补件分类：</label>
                  <span v-html="list_.titleLevelOne"></span>
                </div>
                <el-form-item label="补件分类详情">
                  <el-input class="detailPatch" v-model="list_.titleLevelTwo" placeholder="请输入补件分类详情"></el-input>
                </el-form-item>
                <div>
                  <el-form-item class="investigate" label="对应补件原因">
                    <el-input type="textarea" resize="none" v-model="list_.descLevelTwo" placeholder="请输入补件原因"></el-input>
                  </el-form-item>
                </div>
              </div>
            </div>
          ...
          <div class="form__bottom">
            <el-button :disabled="!compareData" class="add finish" type="primary" @click="finish">保存</el-button>
          </div>
        </div>
      </div>
    </div>
    <saveChanges v-if="alert_" @clsoe_windowused="close_1"/>
    <whetherSaveX :listL="list_.titleLevelTwo" :refer="cause_x" :fn="finish" v-if="alert_1" @close_window="close_3" @clsoe_windowused="close_2"/>
  </div>
</template>
