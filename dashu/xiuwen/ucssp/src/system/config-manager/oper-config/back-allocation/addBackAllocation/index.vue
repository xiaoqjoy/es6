            ...
            <el-form :model="form"
              ...
              <div class="form__block bg__white border__radius-5">
                <div class="dialog-box__form__group">
                  ...
                  <el-form-item class="investigate" label="退回原因" prop="investig">
                    <el-input maxlength="200" type="textarea" resize="none" v-model.trim="form.investig"></el-input>
                  </el-form-item>
                </div>
              </div>
            </el-form>
