                        ...
                        <li v-on:click.native.stop='doSomething' class="table__body">
                          <div class="table__tr">
                            <div class="table__tr__bottom-list" v-show="!item.showEle">
                              ...
                              <div @click.stop.prevent="() => {}" class="operate">
                          ...
                          <ul class="table__box">
                              ...
                              <li v-on:click.native.stop='doSomething' class="table__body">
                                <div class="table__tr">
                                  ...
                                  <li class="table__body">
                                      <div class="table__tr">
                                          <el-form :model="fu_orgForm" :rules="orgRules" :ref="'coownerEditForm' + index" label-width="100px" class="demo-form-inline" label-position="top">
                                              <div class="table__tr__bottom-list" v-show="item.showEle">
                                                  ...
                                                  <div @click.stop.prevent="() => {}" class="operate-box ">
                                                      <i class="icon el-icon-check cursor__pointer" @click="showj('coownerEditForm' + index, index, item)"></i>
                            ...
                            <!-- 子集表格显示 -->
                            <li class="table__body" v-for="(itemz, a) in item.zi_orgForm_a" :key="a">
                              <div class="table__tr">
                                <div class="table__tr__bottom-list" v-show="!itemz.showEle">
                                  <el-form-item class="table__form-item">
                            ...
                            <!-- 子集新增表格 -->
                            <li class="table__body zi_new" v-if="item.zi_orgForm_a.showEle || item.zi_orgForm_a.length === 0">
                                <div class="table__tr">
...
<composite v-if="alert_" :save="save" :refer="refer" @clsoe_windowused='close_3' />
<stateOfPreservation v-if="alert_1" :form_a="form_a" :orgForm_a="orgForm_a" :ruleForm="ruleForm" @clsoe_windowused_b='close_4' @clsoe_windowused='close_2' @clsoe_windowused_a='close_1' />
...
export default {
  ...
  methods: {
    ...
    zi_openAddCoowner(obj, id) {
      ...
      // this.$nextTick(() => {
      //   if (id) {
      //     this.$refs.orgForm[0].clearValidate();
      //   this.$refs.orgForm[1].clearValidate();
      //   } else {
      //      this.$refs.form[0].clearValidate();
      //   this.$refs.form[1].clearValidate();
      //   }
      // });
      // setTimeout(() => {
      //   this.$refs.form[0].clearValidate();
