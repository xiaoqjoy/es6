...
<template>
  <div class="drop_loan">
    ...
    <div class="dialog-box">
      ...
      <div class="complete-product">
        <div class="dialog-box__middle-form">
          <el-form :model="form" ref="form" label-width="100px" class="demo-form-inline" label-position="top">
            <div class="form__block bg__white border__radius-5">
              <div class="dialog-box__form__group">
                ...
                <el-form-item>
                  ...
                  <el-input type="password" v-model="form.certificate_type_code"></el-input>
                </el-form-item>
              </div>
            </div>
          </el-form>
          <div class="form__bottom">
            <el-button class="add finish" type="primary" @click="cancel()">取消</el-button>
    ...
    <!-- <stateOfPreservation :save="form" v-if="alert_1" @clsoe_windowused='close_2' @clsoe_windowused1='close_3' /> -->
  </div>
</template>
