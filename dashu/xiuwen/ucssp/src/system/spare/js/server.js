...
// let host2 = 'http://dsapp13.intsit.dsfdc.com:8103';
let host = 'api/cpms';
let host2 = 'api/cpms'; // 这个暂时请不要改 这个后续我来改（liuzhe）
let host7 = 'api/cpms'; // http://10.3.113.81 税务贷的接口
let host3 = "api/cpms"; // 获取爬虫 - 授权状态
if (process.env.NODE_ENV !== 'production') {
  host = 'http://10.3.113.121:8080';
  // host = 'http://dsapp18.intuat.dsfdc.com/h5/api/cpms';
  // host = 'http://dsapp13.intsit.dsfdc.com:8080/h5/api/cpms';
  host2 = 'http://10.3.113.121:8080';

  host3 = "http://10.3.113.121:8080"; // 获取爬虫 - 授权状态
}
const spareApi = {
  ...
  solving: {
    ...
    completeInfo: {
      ...
      completeCustomerInfo: {
        ...
        queryChannel: host2 + '/cpms/v1/marketing-management/exclusive-channels/available', // 获取可用渠道1
        queryAllChannel: host2 + '/cpms/v1/marketing-management/exclusive-channels/', // 获取全部渠道1
        queryPersonalChannel: host2 + '/cpms/v1/marketing-management/personal-channels/available', // 获取其他可用个人渠道2
        queryAllPersonalChannel: host2 + '/cpms/v1/marketing-management/personal-channels/', // 获取其他全部个人渠道2
        queryCompanyChannel: host2 + '/cpms/v1/marketing-management/organization-channels/available', // 获取可用公司渠道3
        queryAllCompanyChannel: host2 + '/cpms/v1/marketing-management/organization-channels/', // 获取全部公司渠道3
        queryManangeChannnel: host2 + '/cpms/v1/marketing-management/members/available', // 获取可用客户经理4
        queryAllManangeChannnel: host2 + '/cpms/v1/marketing-management/members/', // 获取全部客户经理4
  ...
  taxConfig: {
    // area_tax_organization_list: host7 + '/cpms/v1/tax-loan/area-tax-organization-list', // 获取区域税务机构列表
    // area_tax_organization_list: host7 + '/taxLoan/Organization/list'
    area_tax_organization_list: host7 + '/taxLoan/areaTaxOrganization/list', // 获取区域税务机构列表
    tax_loan_organization_list: host7 + '/taxLoan/Organization/list', // 获取税务接入下拉框下拉框
    careerworkOrganizationList: host7 + '/taxLoan/careerwork/organization/info', // 获取客户所在地区域税务机构列表
    queryAuthory: host7 + '/taxLoan/authorization', // 获取税务授权信息
    queryTaxInfoApi: host7 + '/taxLoan/tax-information', // 获取税务信息
    checkTax: host7 + '/tax-loan/check-tax' // 获取税务信息
  },
  checkTaxLoan: {
