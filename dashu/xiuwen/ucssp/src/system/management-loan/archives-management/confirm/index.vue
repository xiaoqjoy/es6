    ...
    <div class="dialog-box">
      ...
      <div class="complete-product">
        <div class="dialog-box__middle-form">
          <div class="hint"><span>是否确认从</span><span>{{form.effectiveDate}}</span><span>起，将“</span><span>{{compile_data.serviceName}}</span><span>”调整至“</span><span>{{form.serviceName}}</span><span>”？</span></div>
...
export default {
  ...
  props: ["compile_data", "form", "adjust"]
};
</script>
