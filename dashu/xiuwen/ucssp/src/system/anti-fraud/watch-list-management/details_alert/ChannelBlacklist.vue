<template>
    <div class="import-message">
          ...
          >
            ...
            <div class="anti-fraud_dialog-box__middle">
              ...
              <ul class="anti-fraud_dialog-box__middle_two">
                <li ><p><span>法人代表:</span><span v-html="list_s.fictitiousperson"></span></p></li>
                <li><p><span>证件类型:</span><span v-html="list_s.certtype"></span></p></li>
                <li><p><span>证件号码:</span><span v-html="list_s.certid"></span></p></li>
              </ul>
            </div>
            <!-- 单位信息 -->
            <div class="anti-fraud_dialog-box__middle">
              ...
              <ul class="anti-fraud_dialog-box__middle_two">
                <li ><p><span>所属分公司:</span><span v-html="list_s.inputorgid"></span></p></li>
                <li><p><span>单位地址:</span><span v-html="list_s.workcorpadd"></span></p></li>
              </ul>
            </div>
            <!-- 渠道信息 -->
            <div class="anti-fraud_dialog-box__middle">
              <p class="anti-fraud_dialog-box__middle_one"><span></span>渠道信息</p>
              <ul class="anti-fraud_dialog-box__middle_two">
                <li ><p><span>渠道分类:</span><span v-html="list_s.channelclassification"></span></p></li>
                <li><p><span>渠道名称:</span><span v-html="list_s.corpname"></span></p></li>
                <li><p><span>渠道编码:</span><span v-html="list_s.channelcode"></span></p></li>
              </ul>
            </div>
            <!-- 其他信息 -->
            <div class="anti-fraud_dialog-box__middle">
              ...
              <ul class="anti-fraud_dialog-box__middle_two">
                <li><p><span>上关注名单时间:</span><span v-html="list_s.begindate"></span></p></li>
                <li><p><span>登记人:</span><span v-html="list_s.inputuserid"></span></p></li>
                <li><p><span>欺诈性质:</span><span v-html="list_s.fraudtype"></span></p></li>
                <li><p><span>黑名单来源:</span><span v-html="list_s.blacklistsource"></span></p></li>
                <li><p><span>黑名单类型:</span><span v-html="list_s.blacklisttype"></span></p></li>
                <li><p><span>黑名单等级:</span><span v-html="list_s.blacklistgrade"></span></p></li>
                <li><p><span>否决原因:</span><span v-html="list_s.denyreason"></span></p></li>
              </ul>
              <!-- <ul class="anti-fraud_dialog-box__middle_two">
              </ul> -->
              <div class="center">
      ...
      <change :fn='saveText' v-if="isChange" @isChange_s="close_isChange" @clsoe_windowIsChange='console_isChange' />
    </div>
</template>
<script type="text/ecmascript-6">
import change from "../addWatchLists/change"; // 变更
