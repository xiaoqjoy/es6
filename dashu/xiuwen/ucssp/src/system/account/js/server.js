...
let host7 = 'api/cpms'; // http://10.3.113.81
...
if (process.env.NODE_ENV !== 'production') {
  ...
  // host5 = 'http://10.1.114.72:8080'; // 风险定价锁配置
  // host5 = 'http://dsapp13.intsit.dsfdc.com:8103'; // 风险定价锁配置测试地址
  // host7 = 'http://10.3.114.246:8080';
  // host = '/uat/api/cpms';
  ...
  // host7 = '/uat/api/cpms'; // http://10.3.113.81
}
const accountApi = {
  ...
  pricing_lock_controller: {
    pricingLock_list: host5 + '/pricing/pricingLock/list', // 获取定价锁开关配置信息列表
    pricingLock_save: host5 + '/pricing/pricingLock/save', // 新增定价锁配置信息
    pricingLock_delete: host5 + '/pricing/pricingLock/delete', // 根据id删除定价锁配置信息
    pricingLock_update: host5 + '/pricing/pricingLock/update', // 根据id作为条件，修改定价锁配置信息
    common_subcompanies: host5 + '/common/subcompanies', // 获取分公司列表
    pricing_pricingLock: host5 + '/pricing' // 根据id获取定价锁配置信息
  },
  taxConfig: {
    ...
    tax_loan_area_save: host7 + '/taxLoan/areaTaxOrganization/info/save', // /taxLoan/areaTaxOrganization/info/save
    tax_loan_area_update: host7 + '/taxLoan/areaTaxOrganization/info/update', // /taxLoan/areaTaxOrganization/info/update
    tax_loan_area_del: host7 + '/taxLoan/areaTaxOrganization/info/del' // /taxLoan/areaTaxOrganization/info/del
  }
};
export {
  accountApi
