  ...
  <div class="face2face-disposed">
    ...
    <div class="table-area">
      ...
      <el-table :data="tableData" style="width: 100%" class="common__table">
        ...
        <el-table-column prop="productId1" label="产品ID1" width="200"></el-table-column>
        <el-table-column prop="productId1Conclusion" label="产品ID1 面签结论" width="200"></el-table-column>
        <el-table-column prop="productId1DocumentId" label="产品ID1 档案编号" width="200">
        ...
        <el-table-column prop="productId2" label="产品ID2" width="200" v-if="!isXiuwen"></el-table-column>
        <el-table-column prop="productId2Conclusion" label="产品ID2 面签结论" width="200" v-if="!isXiuwen"></el-table-column>
        <el-table-column prop="productId2DocumentId" label="产品ID2 档案编号" width="200" v-if="!isXiuwen">
          <template slot-scope="scope">
