...
let newcontactPerson = {
  contactRelationCode: "",
  contactRemarkTxt1: "",
  contactRemarkTxt2: null,
  id: "",
  phoneCheckInd: false,
  phoneCheckName: "",
  phoneCheckNameCode: "003",
  phoneCheckPhoneNum: null,
  phoneCheckRemarkTxt1: null,
  phoneCheckRemarkTxt2: null,
  apraudAddedInd: true
};
let newcontactThird = {
  contactRelationCode: "",
...
export default {
  ...
  methods: {
    ...
    changeRelation(val) {
      ...
      // this.aplContactInfo[val].auditRemarkTxt = "";
    },
    // 获取居住状况配置列表
    getHouseCondition() {
    ...
    saveOperAll() {
      ...
      if (isPass === 0) {
        ...
        console.log(workAddressEndCode);
        let data = {
