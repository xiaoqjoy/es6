<template>
  ...
  <!-- 主内容 -->
    <div class="content_right_box">
      ...
      <!-- 客户信息 -->
      <div class="content_border" id="#anchor-1">
      ...
      <!-- 贷款信息 -->
      <div class="content_border" id="#anchor-2">
      ...
      <!-- 信用报告信息 -->
      <div class="content_border"  id="#anchor-3">
        ...
        <popup :isShowDialog="isShowCredit" :url="creditReport" :isReport="true" :applicationId="applicationId" menuDesc="调查" :iframe="true" :center="true" :width="800" :height="700" @closeDialog="closeCredit"></popup>
      </div>
      <!-- 关联检测信息 -->
      <div class="content_border" id="#anchor-4">
        <div class="content_title_head" :class="{ content_title_on : activeBtn === 4 }">
          <span class="content_title_headA"></span>
      ...
      <!-- 历史贷款信息 -->
      <div class="content_border"  id="#anchor-5">
        <div class="content_title_head" :class="{ content_title_on : activeBtn === 5 }">
          <span class="content_title_headA"></span>
      ...
      <!-- 备注汇总 -->
      <div class="content_border" id="#anchor-6" :class="{last_padding300 : navArr.length === 7}">
        <div class="content_title_head" :class="{ content_title_on : activeBtn === 6 }">
          <span class="content_title_headA"></span>
        ...
        <div class="content">
          ...
          <div class="content_bottom_border content_text_wrap">
            ...
            <p class="black_font content_text">{{pageData.summaryNoteInfo.checkOpinion}}</p>
          </div>
    ...
    <div v-if="dialogVisible">
      ...
      <face2face-detail class="history-face" :dialogVisible="dialogVisible" :applicationId="oldApplicationId" :creditReportId="creditReportId" @closeDialog="dialogVisible = false"></face2face-detail>
    </div>
  </div>
</template>
...
import { reserveStatusConversion, checkResultConversion, parseAddress } from '../js/utils.js';
  ...
  methods: {
    ...
    emitRecheckData() {
      ...
      if (routerNow.indexOf('recheck') !== -1) {
        this.$emit("setRecheckModel", this.pageData.reportCheckInfo);
      } else {
