                    ...
                    {{ scope.row.estateId }}
							...
							<el-table-column prop="estateTypeCode" label="房产性质">
								<template slot-scope="scope">
									...
									<div v-show="scope.row.isEdit">
                  <el-select v-model="scope.row.estateTypeCode" placeholder="请选择">
				...
				<div class="card_box">
					...
					<div class="card_item_box items_padding_top20">
						<el-form-item label="调查前否决原因" prop="beforeSurveyReject" class="width245">
							<el-select v-model="svyStaffReport.beforeSurveyReject" placeholder="请选择" @change="setBeforeSurveyReject">
