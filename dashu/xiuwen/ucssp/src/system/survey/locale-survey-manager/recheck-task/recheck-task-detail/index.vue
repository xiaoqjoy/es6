<template>
  <div>
    <div class="audit_box" id="audit_box" :class="{'no-scroll': reportDialog}">
        ...
        <div class="content">
          ...
          <el-form :model="recheckModel" :rules="recheckRules" ref="recheckModel" label-width="100px" class="input_box text_left" label-position="top">
            ...
            <el-form-item label="复核结果" prop="checkResult">
              <el-select v-model="recheckModel.checkResult" placeholder="请选择" v-if="fieldConfig.check_result">
      ...
      <survey-detail  @setRecheckModel="setRecheckModel" :nav-bardian="navBardian" @anchor="anchor" ref="surveyDeatil">
...
export default {
  ...
  methods: {
    ...
    setRecheckModel(val) {
      if (val) {
        this.recheckModel.checkOpinion = val.checkOpinion;
        this.recheckModel.checkResult = val.checkResult;
        this.recheckModel.initDistance = val.initDistance;
        this.recheckModel.updatedDistance = val.updatedDistance;
