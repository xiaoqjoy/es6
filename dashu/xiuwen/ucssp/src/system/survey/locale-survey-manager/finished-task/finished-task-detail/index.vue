<template>
  <div>
    <div class="audit_box" id="audit_box" :class="{'no-scroll': reportDialog}">
      ...
      <survey-detail :nav-bardian="navBardian" @anchor="anchor">
          <div slot="survey-booking" class="content_border" id="#anchor-7" slot-scope="props">
          ...
          <div slot="recheck-report" class="content_border" id="#anchor-8" style="padding-bottom: 300px" slot-scope="props">
            <div class="content_title_head" :class="{ content_title_on : activeBtn === 8 }">
              <span class="content_title_headA"></span>
                ...
                <div class="clearfloat topology_margin">
                  <div class="top_conten">
                    <span class="top_conten_title">调查距离：</span><span class="top_content_font">
                      {{props.reportCheckInfo.updatedDistance ? props.reportCheckInfo.updatedDistance : props.reportCheckInfo.initDistance}}
                    </span>
                  </div>
