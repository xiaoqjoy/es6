              ...
              <div class="form__block bg__white border__radius-5" >
                ...
                <div class="dialog-box__form__group">
                  ...
                  <el-form-item label="备注" prop="remarkTxt" class="remark-item">
                    <el-input v-model="form.remarkTxt"></el-input>
                  </el-form-item>
                </div>
              </div>
            </el-form>
...
<script type="text/ecmascript-6">
  ...
  export default{
    ...
    data() {
      let checkRemarkTxt = (rule, value, callback) => {
        if (value.length > 100) {
          return callback(new Error('请输入不多于100个字符'));
        } else {
          callback();
        }
      };
      ...
      return {
        ...
        rules: {
          ...
          remarkTxt: [
            { validator: checkRemarkTxt, trigger: 'blur' }
          ]
        }
      };
    },
