...
<template>
  <div class="contain">
    ...
    <el-form :inline="true" :model="form" class="demo-form-inline">
      <el-form-item label="">
        <el-input v-model="form.organizationChannelId" placeholder="渠道编号"></el-input>
      </el-form-item>
      <el-form-item label="">
      ...
      <el-form-item label="">
        <el-select v-model="form.organizationChannelTypeCode" placeholder="渠道类型">
...
export default {
  ...
  methods: {
    ...
    getData (pageNum) {
      ...
      this.loading = true;
      this.$MyFetch.get(marketingApi.OrganizationChannels, form)
      .then((data) => {
        this.loading = false;
        data = data || {};
