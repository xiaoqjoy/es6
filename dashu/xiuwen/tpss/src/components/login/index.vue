<template>
  <div class="login-page">
    <div class="box">
      <div class="logo">
        <img src="./login.png" height="51" width="256">
      </div>
      <div class="form">
        ...
        <div class="line input">
          ...
          <input type="password" v-model="loginData.password" size="20" placeholder="密码"/>
        </div>
        ...
        <div class="line link">
          <router-link to="/change_password" class="cursor__pointer" style="font-size: 12px; color:#999999; float: right;">修改密码</router-link>
          <div>&nbsp;</div>
        </div>
      </div>
    </div>
          ...
          if (valid) {
            this.$MyFetch.post(api.setDepartment, data)
              .then(data => {
                ...
                this.$router.push({path: '/system/system_page'});
              })
              .catch(err => {
