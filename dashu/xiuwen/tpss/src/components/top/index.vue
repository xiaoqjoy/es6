<template>
  <div class="common__top clearfix font__white">
    ...
    <div class="drop-menu" :class="{active: menuIsOpen}">
      ...
      <span class="name" @click.stop="showMenu" id="topMenu"><span class="name__text">{{userInfo.userName}}</span><i class="el-icon-caret-bottom el-icon--right" :class="{'el-icon-caret-top': menuIsOpen}"></i></span>
