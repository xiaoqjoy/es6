<template>
  <div>
            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-button type="text" size="small" @click="toPatchDetails(scope.$index)">补件查看
                  </el-button>
                </template>
              </el-table-column>
            </el-table>
      ...
      <patchDetails v-if="alertPatch" @clsoe_windowAlert="close_patchDetails" :isReadonly="isReadonly" :isDispose="isDispose"
