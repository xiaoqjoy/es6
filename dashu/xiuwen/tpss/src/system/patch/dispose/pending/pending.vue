<template>
  <div>
            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-button type="text" size="small" @click="toPatchDetails(scope.$index)">补件处理
                  </el-button>
                </template>
              </el-table-column>
            </el-table>
      ...
      <patchDetails v-if="alertPatch" @clsoe_windowAlert="close_patchDetails" :isReadonly="isReadonly" :refresh="getTable"
  ...
  methods: {
    ...
    getTable(page, pageSize) {
      ...
      .then((data) => {
        ...
        console.log(this.tableMsg, '有序号吗');
      })
      .catch(err => {
        this.$message.error(err.message);
      });
