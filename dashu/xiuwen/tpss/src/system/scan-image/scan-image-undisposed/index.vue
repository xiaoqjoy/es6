        ...
        <el-table class="table-noWell" :data="tableData" style="100%">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="$showImage(scope.row.applicationId, '远程面签')">影像扫描</el-button>
              <!-- <el-button type="text" size="small" @click="submitImage(scope.row.applicationId)">提交</el-button> -->
            </template>
          </el-table-column>
        </el-table>
      </div>
...
export default {
  ...
  methods: {
    ...
    getList(flag) {
      ...
      if (!(this.searchInfo.applicationId || this.searchInfo.custName || this.searchInfo.idCardNo)) {
