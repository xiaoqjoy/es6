        ...
        var Z = function() {
          ...
          _ = function() {
            ...
            if (I.browser().msie)
              e =
                ...
                r +
                "' align='center' >" +
                "<param name='wmode' value='transparent'><param name='wndtype' value='" +
                a.iWndowType +
                "'>" +
          ...
          B = function(e) {
            ...
            if (O(e)) (r = F(e)), (t = r.iRtspPort), (n = r.iDevicePort);
              ...
              for (var o = V(e), i = !1, a = 0; o.length > a; a++)
              ...
              i
                ? (r = F(e))
                : ((r = U(e)),
                  -1 == r.iRtspPort && -1 == r.iDevicePort && (r = F(e))),
                (t = r.iRtspPort),
                (s = r.iHttpPort),
                (n = r.iDevicePort);
            }
                ...
                : ((document.getElementById(a.szContainerID).innerHTML = _()),
                  ...
                  null == u && null == u.object
                    ...
                    : ("object" == typeof e.attachEvent &&
                        I.browser().msie &&
                        (u.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
          ...
          I.extend(a, i),
            I.extend(a, {
              success: function(a) {
                ...
                (u.szIP = e),
                  2 == t
                    ? ((u.szHttpProtocol = "https://"), (u.iHttpsPort = s))
                    : ((u.szHttpProtocol = "http://"), (u.iHttpPort = s)),
                  (u.iCGIPort = s),
                  (u.szAuth = n),
                  (u.iDeviceProtocol = r),
                  (u.oProtocolInc = o),
        ...
        (this.I_Login = function(e, t, s, n, r, o) {
          ...
          (this.I_StartRecord = function(e, t) {
            ...
            if (-1 != s) {
              var r = p[s];
              r.bRecord ||
                ((n = u.HWP_StartSave(t, e)), 0 == n && (r.bRecord = !0));
            }
            return n;
          }),
          (this.I_StopRecord = function(e) {
            ...
            if (-1 != t) {
              var n = p[t];
              n.bRecord &&
                ((s = u.HWP_StopSave(e)), 0 == s && (n.bRecord = !1));
            }
            return s;
          }),
          ...
          (this.I_EnableEZoom = function(e) {
            ...
            if (-1 != t) {
              var n = p[t];
              n.bEZoom ||
                ((s = u.HWP_EnableZoom(e, 0)), 0 == s && (n.bEZoom = !0));
            }
            return s;
          }),
          ...
          (this.I_Enable3DZoom = function(e) {
            ...
            if (-1 != t) {
              var n = p[t];
              n.b3DZoom ||
                ((s = u.HWP_EnableZoom(e, 1)), 0 == s && (n.b3DZoom = !0));
            }
            return s;
          }),
          ...
          (this.I_StartPlayback = function(e, t) {
            ...
            if ((I.extend(d, t), -1 != n)) {
              ...
              if (
                ...
                return Z("获取端口号失败"), r;
              I.extend(d, { urlProtocol: i, cgi: o, iPort: a, iChannelID: u }),
          ...
          (this.I_Frame = function(e) {
            ...
            if (-1 != t) {
              var n = p[t],
                r = n.iPlayStatus;
              (r == x || r == z) &&
                ((s = u.HWP_FrameForward(e)), 0 == s && (n.iPlayStatus = z));
            }
            return s;
          }),
          (this.I_Pause = function(e) {
            ...
            if (-1 != t) {
              var n = p[t],
                r = n.iPlayStatus;
              r == x
                ? ((s = u.HWP_Pause(e)), 0 == s && (n.iPlayStatus = T))
                : r == D &&
                  ((s = u.HWP_Pause(e)), 0 == s && (n.iPlayStatus = A));
            }
            return s;
          }),
          (this.I_Resume = function(e) {
            ...
            if (-1 != t) {
              var n = p[t],
                r = n.iPlayStatus;
              r == T || r == z
                ? ((s = u.HWP_Resume(e)), 0 == s && (n.iPlayStatus = x))
                : r == A &&
                  ((s = u.HWP_Resume(e)), 0 == s && (n.iPlayStatus = D));
            }
            return s;
          }),
        ...
        (tt.prototype.CGI = {
          ...
          (tt.prototype.login = function(e, t, n, r) {
            var o = 2 == r.protocol ? "https://" : "http://",
              ...
              a = new et(),
              u = { type: "GET", url: i, auth: n, success: null, error: null };
            I.extend(u, r),
              I.extend(u, {
                success: function(e) {
                  "200" ==
            ...
            I.extend(o, t),
              I.extend(o, {
                success: function(e) {
                  ...
                  for (
                    var r = s.$XML(e).find("InputProxyChannel", !0),
                      o = 0,
                      i = r.length;
                    i > o;
                    o++
            ...
            if (
              (this.getDigitalChannel(e, {
                ...
                success: function(e) {
                  n = e;
                  for (
                    var t = s.$XML(n).find("InputProxyChannel", !0),
                      o = 0,
                      i = t.length;
                    i > o;
                    o++
              ...
              I.extend(a, t),
                I.extend(a, {
                  success: function(e) {
                    ...
                    for (
                      var o = s.$XML(e).find("InputProxyChannelStatus", !0),
                        i = 0,
                        a = o.length;
                      a > i;
                      i++
          ...
          (tt.prototype.ptzAutoControl = function(e, t, s, n) {
            var r = s.iChannelID,
              ...
              i = "";
            if (
              ((n.iPTZSpeed = 7 > n.iPTZSpeed ? 15 * n.iPTZSpeed : 100),
              t && (n.iPTZSpeed = 0),
              e.szDeviceType != X)
            )
              (o =
                e.iAnalogChannelNum >= r
                  ? k(
          ...
          (tt.prototype.ptzControl = function(e, t, s, n) {
            ...
            o =
              ...
              (e.szDeviceType != G &&
                ...
                : k(u.ipc, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID);
            var c = new et(),
              l = {
                type: "PUT",
                url: o,
            ...
            I.extend(o, t),
              I.extend(o, {
                success: function(e) {
                  ...
                  n.push("<InputProxyChannelList>");
                  for (
                    var r = s.$XML(e).find("DynVideoInputChannel", !0),
                      o = 0,
                      i = r.length;
                    i > o;
                    o++
              ...
              I.extend(a, t),
                I.extend(a, {
                  success: function(e) {
                    ...
                    n.push("<InputProxyChannelStatusList>");
                    for (
                      var o = s.$XML(e).find("DynVideoInputChannelStatus", !0),
                        i = 0,
                        a = o.length;
                      a > i;
                      i++
          ...
          (rt.prototype.browser = function() {
            var e = /(webkit)[ \/]([\w.]+)/,
              ...
              i = e.exec(o) ||
                ...
                s.exec(o) ||
                n.exec(o) ||
                (0 > o.indexOf("compatible") && r.exec(o)) || ["unknow", "0"];
          ...
          (rt.prototype.Base64 = {
            ...
            encode: function(e) {
              var t,
                ...
                u = "",
                c = 0;
              for (e = rt.prototype.Base64._utf8_encode(e); e.length > c; )
                (t = e.charCodeAt(c++)),
                  (s = e.charCodeAt(c++)),
                  (n = e.charCodeAt(c++)),
                  (r = t >> 2),
