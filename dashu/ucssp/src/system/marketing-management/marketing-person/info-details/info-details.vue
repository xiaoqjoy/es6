...
<template>
  <div class="drop_loan">
            ...
            <div class="form__block bg__white border__radius-5" >
              ...
              <div class="dialog-box__form__group">
                ...
                <el-form-item label="个贷资格" prop="memberProduct">
                  <el-select multiple collapse-tags v-model="form.memberProduct" placeholder="请选择">
    ...
    <qr-code v-if="qrCode"
      :post_type="post_type"
      :userId="userId"
      :umName="data.userName"
      :marketTeamId="row.team.marketTeamId"
      :organizationId="row.team.organizationId"
      :teamName ="row.team.marketTeamName"
      :companyName ="row.team.organizationName"
...
<script type="text/ecmascript-6">
  ...
  export default{
    ...
    computed: {
      ...
      detail() {
        return !this.authority && !this.history && !this.transfer && !this.transferHistory && !this.qrCode;
      }
    },
    data() {
    ...
    methods: {
      ...
      showQrCode(row) {
        ...
        // this.marketTeamId = row.team.marketTeamId;
        // this.organizationId = row.team.organizationId;
        // this.marketTeamName = row.team.marketTeamName;
        // this.organizationName = row.team.organizationName;
        this.qrCode = true;
      },
      getFromUserId() {
