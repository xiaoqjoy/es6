          ...
          style="width: 100%">
            <el-table-column width="44">
              <template slot-scope="scope">
                <el-checkbox :disabled="scope.row.isDisabled" v-model="scope.row.isSelect" @change="check(scope)"></el-checkbox>
              </template>
            </el-table-column>
            <el-table-column
              prop="userId"
    ...
    methods: {
      ...
      getData(pageNum) {
        ...
        let form = Object.assign({}, this.searchForm, {
          ...
          organizationId: this.rowProp.organizationId,
          pageNum
        });
        ...
        .then((data) => {
          ...
          if (this.tableData) {
            for (let i = this.tableData.length - 1; i >= 0; i--) {
              ...
              if (this.tableData[i].userId === this.umAccount) {
                this.$set(this.tableData, i, Object.assign({}, this.tableData[i], {isDisabled: true}));
              }
              this.$set(this.tableData, i, Object.assign({}, this.tableData[i], {isSelect: false}));
            }
          }
