  ...
  methods: {
    ...
    edit_alert(data) {
      ...
      let data1 = {
        ...
        operateType: "0", // 操作类型(0制作|1复核))
        paperArchivesId: data.paperArchivesId // 档案编号
      };
      this.$MyFetch
        .get(url, data1)
        .then((datac = {}) => {
          // if (this.datac.feeListDtos === null) {
          //   this.datac.feeListDtos = [];
          //   this.compile_data = this.datac;
          // } else if (this.datac.feeListDtos.length === 0) {
          //   this.compile_data = this.datac;
          // }
          // if (this.datac.feeLists === null) {
          //   this.datac.feeLists = [];
          //   this.compile_data = this.datac;
          // } else if (this.datac.feeLists.length === 0) {
          //   this.compile_data = this.datac;
          // }
          // if (this.datac.feeListDtos === null && this.datac.feeLists === null) {
          //   this.datac.feeListDtos = [];
          //   this.datac.feeLists = [];
          //   this.compile_data = this.datac;
          // } else if (
          //   this.datac.feeLists.length === 0 &&
          //   this.datac.feeListDtos.length === 0
          // ) {
          //   this.compile_data = this.datac;
          // } else if (
          //   this.datac.feeLists.length !== 0 &&
    ...
    refer(pageNum, id) {
      ...
      let data = {
        ...
        checkInd: 0, // 档案复核状态,2-已复核|1-待复核|0-待处理
        custName: this.custName, // 客户姓名
        handleStatusInd: false, // 档案处理状态,true-已处理|false-待处理
