<template>
  <div>
    ...
    <particulars v-if="alert" :refer="refer" :compile_data="compile_data" @clsoe_windowAlert='close' />
  </div>
</template>
  ...
  methods: {
    ...
    edit_alert(data) {
      ...
      this.$MyFetch
        ...
        .then((datac = {}) => {
          ...
          this.$set(this.compile_data, 'arcReviewer', data.arcReviewer);
    ...
    refer(pageNum, id) {
      ...
      let data = {
        ...
        checkInd: 2, // 档案复核状态,2-已复核|1-待复核|0-待处理
