...
<template>
  <div>
          ...
          <div class="audit_bottom_content grid-content bg-purple" style="margin-bottom: 60px">
            <div class="content_right_box">
                ...
                <div class="content">
                  <div class="content_mian">
                    <ic-info :showSpouse="true" :disabled="!!isEdit"
                      ...
                      :isDetail="!!isEdit" :routerPath="'audit-ic-info-detail'" :taskNodeCode="'preAuditTask'">
                    </ic-info>
                  </div>
                </div>
              </div>
              ...
              <div class="content_border jump-hook" id="selfGo-9" v-if="!isSourceSurvey">
                ...
                <credit-report :isEdit="isEdit" :taskNode="'audit'" :applicationId="applicationId" :moduleCode="'apraud'"></credit-report>
              </div>
              <!-- 运营商报告 -->
                      ...
                      <el-row :gutter="20">
                        ...
                        <el-col :span="8">
                          <div class="input-control dadaoNum">
                            <el-form-item label prop="adjustmentAmt">
                              <label>可调整金额：</label>
                              <!-- <el-input v-model="aplRiskPara.AdjustableBalance"></el-input> -->
                              <input
                                type="text"
                                v-model.lazy="aplRiskPara.adjustmentAmt"
                                :disabled="isEdit"
              ...
              <!-- 审计结论 -->
              <div class="content_border jump-hook" id="selfGo-17">
                <div class="content_title_head" :class="{'active__title' : curIndex === 17}">
                  <span class="content_title_headA"></span>
                  <span class="content_title_headB" id="anchot-17">预审计结论</span>
                </div>
    ...
    <!-- 备注 -->
    <remark v-if="alertRemark" :isPre="true" @clsoe_windowAlert="close_remark" :disabled="isEdit"/>
    <!-- 补件 -->
    <patchBolt
      v-if="alertPatchBolt"
      :disabled="isEdit"
...
<script src="./pre-audit.js"></script>
