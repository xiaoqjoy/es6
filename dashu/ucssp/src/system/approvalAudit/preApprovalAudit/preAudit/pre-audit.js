...
export default {
  ...
  computed: {
    ...
    // },
    remarkTxt: function () {
      // return this.preAprConclusion.join();
  ...
  methods: {
    ...
    gettaskDetail() {
      return new Promise((resolve, reject) => {
        let url = '';
        if (this.isEdit) {
          url = `${aprAudApi.aud.taskDetail.preTaskDetailReadonly}/${this.applicationId}`;
        } else {
          url = `${aprAudApi.aud.taskDetail.preTaskDetail}/${this.applicationId}`;
        }
        this.$MyFetch
          .get(url)
          .then((data = {}) => {
    ...
    saveOperAll() {
      ...
      if (isPass === 0) {
        ...
        let data = {
          ...
          "remarkTxt": this.preAudConclusion.decisionTxt, // 审批结论
    ...
    getRuleDetection() {
      ...
      // }
      this.$MyFetch
        .get(`${aprAudApi.aud.taskDetail.preRuleDetection}/${this.applicationId}`, data)
        .then((data = {}) => {
