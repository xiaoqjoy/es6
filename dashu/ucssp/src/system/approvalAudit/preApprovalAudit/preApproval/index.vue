            ...
            <div class="content_right_box">
              ...
              <div class="content_border jump-hook" id="selfGo-1">
                <div class="content_title_head" :class="{'active__title' : curIndex === 1}">
                  <span class="content_title_headA"></span>
                  <span class="content_title_headB" id="anchot-1">客户信息</span>
                </div>
                <div class="content">
                  ...
                  <div class="clearfloat">
                    ...
                    <div class="top_conten">
                      <span class="top_conten_title">手机号：</span>
                      <span class="top_content_font">{{ruleForm.mobileNum}}</span>
                    </div>
                    <div class="top_conten">
                  ...
                  <div class="input_box">
                    <basis-info ref="basisInfo" :isDetail="isEdit" :applicationId="applicationId" :dict="dictLib" :custBasicInfo="ruleForm" :customerContactsInfo="custPertction.customerContactsInfo"></basis-info>
                  </div>
                  <div class="basic-info-header form__block_header">
                    <h5 class="title"><span class="icon icon__gan"></span>补充个人信息</h5>
                  </div>
                  <div class="input_box">
                    <add-info ref="addInfo" :isDetail="isEdit" :dict="dictLib" :custDetailedInfo="custPertction.customerAddInfo"></add-info>
                  </div>
                  <div class="input_box">
                    <special-product ref="specialProduct" :isDetail="isEdit" v-if="showSpecial" :orgSpecialInfo="custPertction.orgSpecialInfo" :applicationId="applicationId"></special-product>
                  </div>
                </div>
              </div>
              <!-- 单位信息 -->
              <div class="content_border jump-hook" id="selfGo-2" v-if="false">
              ...
              <div class="content_border jump-hook" id="selfGo-4" v-if="!isSourceSurvey">
                ...
                <div class="content">
                  <ul class="table__list">
                    ...
                    <div class="content_mian_title" v-if="false">
                ...
                <div class="content">
                  <div class="content_mian">
                    <ic-info :showSpouse="true" :disabled="!!isEdit"
                      :apiUrl="icInfo_url" :applicationId="applicationId" :certId="ruleForm.spouseID"
                      :isDetail="!!isEdit" :routerPath="'audit-ic-info-detail'" :taskNodeCode="'preApproveTask'">
                    </ic-info>
                  </div>
                </div>
              </div>
              ...
              <div class="content_border jump-hook" id="selfGo-9" v-if="!isSourceSurvey">
                ...
                <credit-report :isEdit="isEdit" :taskNode="'approval'" :applicationId="applicationId" :moduleCode="'apraud'"></credit-report>
              </div>
              <!-- 运营商报告 -->
              ...
              <!-- 企业发票数据 -->
              <div
                v-if="(isNuonuo || isChanjet || isDCG || isDCGX || hasInvoice) && !isSourceSurvey"
                class="content_border jump-hook"
                id="selfGo-13">
              ...
              <!-- 风险参数 -->
              <div class="content_border jump-hook" id="selfGo-14" v-if="!isSourceSurvey">
                <div class="content_title_head" :class="{'active__title' : curIndex === 14}">
                  <span class="content_title_headA"></span>
                  <span class="content_title_headB" id="anchot-14">风险参数</span>
                </div>
                <div class="content" v-if="!isDadao">
                  <!-- {{aplRiskPara.switchHighScoreInd}} -->
                  <div class="bg-purple">
              ...
              >
                <div class="content_title_head" :class="{'active__title' : curIndex === 15}">
                  <span class="content_title_headA"></span>
                  <span class="content_title_headB" id="anchot-15">电核结论</span>
                </div>
                <div class="content">
                  <div class="content_mian">
                    ...
                    >
                      ...
                      <p
                        v-if="phoneCheckConclusion.taskNodeCode === 'preApproveTask'"
                    ...
                    >
                      ...
                      <p
                        v-if="phoneCheckConclusion.taskNodeCode === 'preAuditTask'"
                        v-for="(item, index) in phoneCheckConclusion.phoneCheckContentArray"
                        :key="item + index + 'i'"
                      >{{item}}</p>
                    </div>
              ...
              <!-- 审批结论 -->
              <div class="content_border jump-hook" id="selfGo-16" v-if="!isSourceSurvey">
                <div class="content_title_head" :class="{'active__title' : curIndex === 16}">
                  <span class="content_title_headA"></span>
                  <span class="content_title_headB" id="anchot-16">预审批结论</span>
                </div>
                <div class="content">
                  <div
                    class="content_mian"
              ...
              <!-- 审批退回原因 -->
              <div class="content_border jump-hook" v-if="sendBackFlg" id="selfGo-17">
                <div class="content_title_head" :class="{'active__title' : curIndex === 17}">
                  <span class="content_title_headA"></span>
                  <span class="content_title_headB" id="anchot-17">预审计退回原因</span>
                </div>
                <div class="content" style="min-height:50px">
                  <div
                    class="content_mian"
                    v-if="preAudConclusion.conclusionList.length > 0"
                    v-for="(items, index) in preAudConclusion.conclusionList"
                    :key="index"
                  >
                    <span class="top_conten_title">预审计人员：</span>
...
<script src="./pre-approval.js"></script>
