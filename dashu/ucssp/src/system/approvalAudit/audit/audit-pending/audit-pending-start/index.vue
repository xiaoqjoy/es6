...
<template>
  <div>
          ...
          <div class="backAudit">
            ...
            <div class="image_blue">
              <!-- <el-button
                ...
                v-if="isEdit"
                type="text"
                @click="openImagePlatform('audit', isEdit, '贷款审计')"
              >影像资料</el-button>
              <el-button
                class="sytCBlue"
                v-else
              ...
              <el-button
                ...
                v-if="isPlusLoan"
                type="text"
                @click="$showImage(applicationId, '贷款审计', {ReadOnly: comeFrom !== 'pending' ? '0': undefined, menuId: 'approvalAudit/approval/pulsLoan'})"
              >影像资料</el-button>
          ...
          <div class="audit_bottom_content grid-content bg-purple" style="margin-bottom: 60px">
            <div class="content_right_box">
                ...
                <div class="content">
                  ...
                  <div class="input_box">
                    ...
                    >
                      ...
                      <el-form-item label="户籍详细地址" class="is-required" prop="registeredAddressDesc" v-if="isCX">
                        <input
                          type="text"
                          maxlength="100"
                ...
                <div class="content">
                  <ul class="table__list">
                    <div v-if="showBORF">
                      ...
                      <li class="item">
                        <insurance-table :isDetail="isEdit" :dictLib="dictLib" :applicationId="applicationId"></insurance-table>
                      </li>
                    </div>
                    <div class="content_mian_title">
                      <span>房产信息</span>
              ...
              <div class="content_border jump-hook" id="selfGo-9" v-if="!isSourceSurvey">
                ...
                <credit-report :isEdit="(isEdit && plusEmailStatus !== 'send_success') || comeFrom !== 'pending'" :taskNode="'audit'" :applicationId="applicationId" :moduleCode="'apraud'"></credit-report>
              </div>
              <!-- 运营商报告 -->
              ...
              <div class="content_border jump-hook" id="selfGo-17" v-if="ydApproveMode2">
                ...
                <div class="content">
                  ...
                  <!-- <div class="content_mian">
                    <div class="faceCheckOpinionCode2">
                      <span class="top_conten_title">外网查询结论：</span>
                      <span class="top_content_font">{{preAprConclusion.f2fExtranetStatusCode}}</span>
                    </div>
                    <div class="faceCheckOpinionCode2">
                      <span class="top_conten_title">外网查询备注：</span>
                      <span class="top_content_font">{{preAprConclusion.f2fExtranetRemark}}</span>
                    </div>
                  </div> -->
                </div>
              </div>
              ...
              <div class="content_border jump-hook" id="selfGo-19" v-if="!isSourceSurvey">
                ...
                <div class="content">
                  ...
                  <div class="content_mian">
                    <div class="faceCheckOpinionCode2">
                      <span class="top_conten_title">外网查询结论：</span>
                      <span class="top_content_font">{{getExtranetStatus(aprConclusion.aprExtranetStatusCode)}}</span>
                    </div>
                    <div class="faceCheckOpinionCode2">
                      <span class="top_conten_title">外网查询备注：</span>
                      <span class="top_content_font">{{aprConclusion.aprExtranetRemark}}</span>
                    </div>
                  </div>
                </div>
              </div>
              <!-- 审计结论 -->
              <div class="content_border jump-hook" id="selfGo-20">
                <div class="content_title_head" :class="{'active__title' : curIndex === 20}">
                  <span class="content_title_headA"></span>
                  <span class="content_title_headB" id="anchot-20">审计结论</span>
                </div>
                <div class="content" style="min-height:50px">
                  <div class="content_mian">
                    <div class="extrane">
                      <label>外网查询结论：</label>
                      <el-select placeholder="请选择" v-model="audConclusion.audExtranetStatusCode" :disabled="isEdit">
                        <el-option v-for="item in extranetStatusCodes" :key="item.itemCode" :label="item.itemDesc" :value="item.itemCode"></el-option>
                      </el-select>
                    </div>
                    <textarea
                      ...
                      rows="10%"
                      :style="{'resize':'none', 'width': '100%', 'height': '110px', 'outline': 'none', 'border': '1px solid #d0d0d0', 'margin': '10px 0'}"
                      v-model.lazy="audConclusion.audExtranetRemark"
                      placeholder="请输入外网查询备注"
                    ></textarea>
                    <textarea
                      :disabled="isEdit"
                      ...
                      cols="100%"
                      :style="{'resize':'none', 'width': '100%', 'height': '110px', 'outline': 'none', 'border': '1px solid #d0d0d0'}"
                      v-model.lazy="audConclusion.decisionTxt"
                      maxlength="1000"
                      placeholder="请输入审计结论"
                    ></textarea>
                  </div>
    ...
    <!-- 备注 -->
    <remark v-if="alertRemark" @clsoe_windowAlert="close_remark" :disabled="isEdit && plusEmailStatus !== 'send_success'"/>
    <!-- 补件 -->
    <patchBolt
      v-if="alertPatchBolt"
