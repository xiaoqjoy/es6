<template>
  <div class="mortgage_review_unprocessed">
    <!-- 查询表单 -->
    ...
    <el-table height="600"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="reviewFn(scope.row)">办押复核</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <mortageDetail
      @closeDetail="closeFn"
      v-if="showDetail"
      :submitUrl="collateralApi.submit"
  ...
  data() {
    return {
      ...
      tableCols: [
        ...
        { label: '合作机构', prop: 'orgName' },
        { label: '个贷服务中心', prop: 'serviceName' },
        { label: '办押提交时间', prop: 'mortgageSubmitDate', width: '160px' },
