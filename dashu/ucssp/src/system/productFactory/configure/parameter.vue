				...
				<div class="popup_content">
					...
					<div class="popup_float">
						...
						<el-select v-model='details.inputType' placeholder="请选择">
							...
							<el-option label="级联下拉列表" value="cascaderSelect"></el-option>
							...
							<el-option label="导出" value="fileExport"></el-option>
						</el-select>
					</div>
					<div class="popup_float">
	...
	export default {
		...
		methods: {
			...
			getParameterTypeList() {
				this.$MyFetch.post(poductApi.getDictionaryList, {catalogNo: "ParameterType"}, {timeout: 300000})
					.then((data = {}) => {
						console.log(data);
