<template>
	<div class="date">
		...
		<el-date-picker style="width: 220px;" @change="changeData()" @blur='data.inputIsRequired==="1"?inputblur():noblur()' :disabled='data.inputIsReadonly==="1"||disabledflag||changeFlag' v-model="parameterValue" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" :placeholder="data.placeholder">
		</el-date-picker>
