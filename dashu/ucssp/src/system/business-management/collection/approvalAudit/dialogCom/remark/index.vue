...
import {aprAudApi} from "../../../../js/server";
  ...
  export default {
    ...
    created() {
       if (this.appOrAud) {
            this.url = `${aprAudApi.taskDetail.remarkPage}/${this.$route.query.appID}`;
          } else {
            this.url = `${aprAudApi.aud.taskDetail.remarkPage}/${this.$route.query.appID}`;
          };
