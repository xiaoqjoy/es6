          ...
          <div class="form__block bg__white border__radius-5">
            ...
            <div class="dialog-box__form__group">
              ...
              <el-form-item label="楼层" prop="floor">
                <el-input placeholder="请填写" v-model="houseEdit.floor" maxlength="10"></el-input>
              </el-form-item>
              <el-form-item label="总楼层" prop="totalFloor">
                <el-input placeholder="请填写" v-model="houseEdit.totalFloor" maxlength="10"></el-input>
              </el-form-item>
              <el-form-item label="小区学区类型" prop="communityEduType">
                <el-select placeholder="请选择" v-model="houseEdit.communityEduType">
                  <el-option
                    v-for="item in communityEduType"
                    :key="item.itemCode"
                    :value="item.itemCode"
                    :label="item.itemDesc">
                  </el-option>
              ...
              <el-form-item label="人工录入均价（元）" prop="inputAverageAmt">
                <el-input placeholder="请填写" v-model="houseEdit.inputAverageAmt" maxlength="10"></el-input>
              </el-form-item>
              <el-form-item label="综合评估均价（元）" prop="assessmentAveragePrice">
                <el-input placeholder="请填写" v-model="houseEdit.assessmentAveragePrice" maxlength="20"></el-input>
              </el-form-item>
                    ...
                    <el-form :model="detaineesEdit"
                      ...
                      <div class="table__tr__bottom-list" v-show="item.showEle">
                        ...
                        <el-form-item class="table__form-item">
                          <el-input v-model="detaineesEdit.preLoanAgency" maxlength="100"></el-input>
                        </el-form-item>
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        houseRule: {
          ...
          houseYearCnt: [
            { validator: myRule.positiveRule2, trigger: 'blur' }
          ],
          mortgageInd: [
          ...
          floor: [
            { required: true, message: '请填写楼层数', trigger: 'blur' },
            { validator: myRule.nonNegative5, trigger: 'blur' }
          ],
          totalFloor: [
            { required: true, message: '请填写总楼层数', trigger: 'blur' },
    ...
    created() {
      ...
      this.$getDictCode('community_edu_type', {getAll: this.hasSubmit})
        .then(data => {
          this.communityEduType = data;
          // console.log(data);
        });
    },
    methods: {
      ...
      saveHouse() {
        this.$refs.houseForm.validate((valid) => {
          if (valid) {
            ...
            // console.log(parseInt(this.houseEdit.floor));
            let addressCode = this.houseEdit.addressCode;
            this.houseEdit.floor = parseInt(this.houseEdit.floor);
            this.houseEdit.totalFloor = parseInt(this.houseEdit.totalFloor);
            let data = {
              aplEstateInfo: {
              ...
              aplEstateSupplement: {
                ...
                assessmentAveragePrice: this.houseEdit.assessmentAveragePrice,
                commonCondition: this.houseEdit.commonCondition,
                pledgeDt: this.houseEdit.pledgeDt,
                floor: this.houseEdit.floor,
                totalFloor: this.houseEdit.totalFloor,
                communityEduType: this.houseEdit.communityEduType
              },
