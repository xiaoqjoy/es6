    ...
    <div v-if="newOrOld2" class="import-message2">
      ...
      <div class="dialog-box">
        <div v-if="pOrCalert" class="dialog-box__top">
          <span class="title">{{newMessage.title}}</span>
          <span class="el-icon-close button button__close"></span>
          <div class="content">
            <div class="content_box">
              <div class="content_box_value">
                <span class="content_title">涉案企业:&nbsp;&nbsp;</span><span>{{newMessage.name}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">案件标题:&nbsp;&nbsp;</span><span>{{newMessage.title}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">案件类型:&nbsp;&nbsp;</span><span>{{newMessage.writtype}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">案件字号:&nbsp;&nbsp;</span><span>{{newMessage.casenum}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">审结日期:&nbsp;&nbsp;</span><span>{{newMessage.sslong}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">审理程序:&nbsp;&nbsp;</span><span>{{newMessage.vprogram}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">案由:&nbsp;&nbsp;</span><span>{{newMessage.casetopic}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">案件内容:&nbsp;&nbsp;</span><span>{{newMessage.content}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">执行法院:&nbsp;&nbsp;</span><span>{{newMessage.court}}</span>
              </div>
            </div>
          </div>
        </div>
        <div v-else class="dialog-box__top">
          ...
          <div class="content">
            <div class="content_box">
              <div class="content_box_value">
                <span class="content_title">被执行人姓名或名称:&nbsp;&nbsp;</span><span>{{newMessage.name}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">证件号码:&nbsp;&nbsp;</span><span>{{newMessage.id}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">执行法院:&nbsp;&nbsp;</span><span>{{newMessage.court}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">执行案号:&nbsp;&nbsp;</span><span>{{newMessage.casenum}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">执行内容:&nbsp;&nbsp;</span><span>{{newMessage.content}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">立案时间:&nbsp;&nbsp;</span><span>{{newMessage.sslong}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">执行状态:&nbsp;&nbsp;</span><span>{{newMessage.state}}</span>
              </div>
              <div class="content_box_value">
                <span class="content_title">异议备注:&nbsp;&nbsp;</span><span>{{newMessage.remark}}</span>
              </div>
            </div>
          </div>
        </div>
