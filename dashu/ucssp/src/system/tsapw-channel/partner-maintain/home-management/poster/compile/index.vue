...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        link: [{ validator: rules.website, trigger: "change" }]
      }
    };
  },
  methods: {
        ...
        this.$refs[formName].validate(valid => {
          if (valid) {
            let data = {
              ...
              url: this.url,
              // fileId: "fGL7ew1L0lo3EhMDQ1KQ3t",
              fileId: this.fileId,
              link: this.form.link
            };
            // 调取接口
            let url = `${partnerApi.banner}/${this.compile_data.id}`;
            console.log(data);
            this.$MyFetch
              .put(url, data)
              .then((data = {}) => {
  ...
  mounted() {
    console.log(this.compile_data, "look");
  }
};
</script>
