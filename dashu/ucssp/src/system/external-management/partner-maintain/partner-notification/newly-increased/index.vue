          ...
          >
            <div class="form__block bg__white border__radius-5">
              <div class="dialog-box__form__group">
                ...
                <div class="select">
                <el-radio v-model="radio" @change="switch1" :label="true">推送对象</el-radio>
                <el-radio v-model="radio" @change="switch2" :label="false">上传名单</el-radio>
                </div>
                <el-form-item
                  v-if="radio"
                >
                ...
                <el-form-item
                  ...
                  class="uploading"
                >
                  <el-input v-model="form.contact_num" placeholder="请选择上传文件"></el-input>
                </el-form-item>
                <el-form-item>
                <el-upload
                  v-if="!radio"
...
export default {
  ...
  methods: {
    ...
    close() {
     ...
     uploadUrl() {
      //  var url = "http://10.3.114.136:8097/dpms/appWeb/pushMsgManagerRef/import";
    ...
    finish(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          let pushObj = [];
          if (this.form.pushObject.length > 0) {
          ...
          // 调取接口
          let url = partnerApi.pushMsgManagerRef_addMsg;
          console.log(data);
          this.$MyFetch
            .post(url, data)
            .then((data = {}) => {
