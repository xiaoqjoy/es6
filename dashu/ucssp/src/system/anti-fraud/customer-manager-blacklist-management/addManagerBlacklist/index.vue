    ...
    <div class="import-message">
      ...
      <div class="dialog-box">
        ...
        <div class="dialog-box__top">
          <h5 class="title bg__white">新增客户经理黑名单</h5>
        ...
        <div class="dialog-box__body">
          ...
          <div class="anti-fraud_dialog-box__middle">
            <p class="anti-fraud_dialog-box__middle_one"><span></span>个人信息</p>
            <ul class="anti-fraud_dialog-box__middle_two">
              <li ><p><span>客户姓名:</span><span v-html="blacklistIntroduces.customerName"></span></p></li>
              <li><p><span>证件类型:</span><span v-html="documentType"></span></p></li>
              <li><p><span>证件号码:</span><span v-html="blacklistIntroduces.iDNumber"></span></p></li>
              <li><p><span>手机号码:</span><span v-html="blacklistIntroduces.phoneNumber"></span></p></li>
            </ul>
          </div>
          <!--营销人员信息  -->
          <div class="anti-fraud_dialog-box__middle">
            <p class="anti-fraud_dialog-box__middle_one"><span></span>营销人员信息</p>
            <ul class="anti-fraud_dialog-box__middle_two">
              <li ><p><span>营销人员编码:</span><span v-html="blacklistIntroduces.marketerCode"></span></p></li>
              <li><p><span>所属营销单位:</span><span v-html="blacklistIntroduces.marketDepart"></span></p></li>
            </ul>
          </div>
          <!-- 其他信息 -->
          <div class="anti-fraud_dialog-box__middle">
                ...
                <div class="moude">
                  <ul>
                    <li>
                      <p>黑名单来源</p>
                      <el-form-item>
                        <el-input v-model="sourceBlacklist" maxlength="100" class="select_245" placeholder="请填写">
                        </el-input>
                      </el-form-item>
                    </li>
                    <li>
                      <p>黑名单类型</p>
                      <el-form-item>
                        <el-input v-model="typeBlacklist" maxlength="100" class="select_245" placeholder="请填写">
                        </el-input>
                      </el-form-item>
                    </li>
                    <li>
          ...
          <div class="anti-fraud_dialog-box__middle">
            ...
            <input type="text" maxlength="200" v-model="comment" placeholder="请填写备注">
            </div>
          </div>
        </div>
        <!-- 底部 -->
      ...
      <!-- 组件 -->
      <khjl :blacklistIntroduces="blacklistIntroduces" v-if="impont_"  @clsoe_windowIsChange_khjl='console_isChange_khjl' />
    </div>
</template>
<script type="text/ecmascript-6">
import khjl from "../addManagerBlacklist/importBlacklist/index"; // 引入客户经理弹窗
  ...
  methods: {
    ...
    save() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        ...
        if (valid) {
          if (
            this.blacklistIntroduces.customerName !== "" &&
            this.blacklistIntroduces.iDNumber !== "" &&
            this.blacklistIntroduces.marketerCode !== "" &&
            this.blacklistIntroduces.marketerCode !== ""
          ) {
            console.log("验证通过了");
            // 新增->保存按钮
            let data = {
              ...
              customertype: "5", // 客户类型
              customername: this.blacklistIntroduces.customerName, // 客户姓名
              certtype: "Ind01", // 证件类型
              certid: this.blacklistIntroduces.iDNumber, // 证件号码
              mobilephone: this.blacklistIntroduces.phoneNumber, // 手机号码
              saleserialno: this.blacklistIntroduces.marketerCode, // 营销人员编码
              salebelongorg: this.blacklistIntroduces.marketDepart, // 所属营销单位
            ...
            this.confirmFn("请先引入客户经理黑名单信息", "err");
          }
        } else {
    ...
    get_data() {
      let data = {
        codenoList: ["RejectBlack", "CheatOrNot", "InvalidOReffective"]
      };
...
.moude > ul > li:nth-child(1) {
  clear: both;
}
// .moude > ul > li:nth-child(7) {
//   clear: both;
// }
// 备注
.input > input {
