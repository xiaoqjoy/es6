<template>
  <div>
    <div class="content">
      ...
      <div class="b_content">
        <el-form
          ...
          class="demo-ruleForm"
        >
          <el-form-item label prop="gzdwmc">
            <el-input clearable class="select_4" maxlength="200" v-model="ruleForm.gzdwmc" placeholder="工作单位名称"></el-input>
          </el-form-item>
          <el-form-item label prop="gzdwdz">
            <el-input clearable class="select_4" maxlength="200" v-model="ruleForm.gzdwdz" placeholder="工作单位地址"></el-input>
          </el-form-item>
          ...
          <el-form-item label prop="fjyy">
            <el-select clearable class="select_4" v-model="ruleForm.fjyy" placeholder="否决原因">
              <el-option v-for="item in hmd" :key="item.name" :label="item.name" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label prop="djr">
            <el-input clearable class="select_2" maxlength="20" v-model="ruleForm.djr" placeholder="登记人"></el-input>
          </el-form-item>
      ...
      <div class="tables">
        ...
        >
          ...
          <el-table-column width="300" sortable prop="workcorpname" label="工作单位名称"></el-table-column>
          <el-table-column sortable prop="fraudtype" label="欺诈性质"></el-table-column>
          <el-table-column sortable prop="denyreason" label="否决原因"></el-table-column>
          <el-table-column sortable prop="begindate" label="上关注名单时间"></el-table-column>
          <el-table-column sortable prop="inputuserid" label="登记人"></el-table-column>
          <el-table-column sortable prop="effectivedate" label="黑名单生效时间"></el-table-column>
          <el-table-column sortable prop="invaliddate" label="黑名单失效时间"></el-table-column>
    ...
    <!-- 引入组件 -->
    <addNewBlacklist :refreshList="refreshList" v-if="alert_" @clsoe_windowAlert="close_1"/>
...
import addNewBlacklist from "./addNewBlacklist"; // 新增组件
...
import xq from "../watch-list-management/details_alert/BlacklistManagement"; // 详情组件
import hint from "../watch-list-management/hint"; // 提示组件
...
export default {
  ...
  methods: {
    ...
    saveText_s(file) {
      ...
      data.append("customertype", "4"); // 客户类型
    ...
    xq(detail) {
      ...
      this.$MyFetch
        ...
        .then((data = {}) => {
          this.list = data;
          // if (parseInt(this.list.status1) === 1) {
          //   this.list.status1 = "是";
          // } else if (parseInt(this.list.status1) === 0) {
          //   this.list.status1 = "否";
          // }
    ...
    refreshList(pageNum) {
      if (
        this.ruleForm.gzdwmc ||
        this.ruleForm.gzdwdz ||
        this.ruleForm.qzxz ||
        this.ruleForm.fjyy ||
        this.ruleForm.zt ||
        this.ruleForm.djr ||
        ...
        let data = {
          customertype: "4", // 客户类型
          workcorpname: this.ruleForm.gzdwmc, // 工作单位名称
          workcorpadd: this.ruleForm.gzdwdz, // 工作单位地址
          fraudtype: this.ruleForm.qzxz, // 欺诈性质
          denyreason: this.ruleForm.fjyy, // 否决原因
