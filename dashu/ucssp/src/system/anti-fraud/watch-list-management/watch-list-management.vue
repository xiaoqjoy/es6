<template>
  <div>
    <div class="content">
      ...
      <div class="b_content">
        ...
        >
          <el-form-item label prop="name">
            <el-input clearable class="select_2" maxlength="80" v-model="ruleForm.name" placeholder="姓名"></el-input>
          </el-form-item>
          ...
          <el-form-item :prop="'certificateNum' + carType">
            <el-input
              ...
              class="select_4"
              placeholder="证件号码"
              :disabled="!ruleForm.certificateTypeCode"
              v-model="ruleForm['certificateNum' + carType]"
            ></el-input>
          </el-form-item>
          <el-form-item label prop="qzxz">
            <el-select clearable class="select_4" v-model="ruleForm.qzxz" placeholder="欺诈性质">
              <el-option
          ...
          <el-form-item label prop="zt">
            <el-select clearable class="select_4" v-model="ruleForm.zt" placeholder="状态">
              <el-option
          ...
          <el-form-item label prop="djr">
            <el-input clearable maxlength="20" class="select_4" v-model="ruleForm.djr" placeholder="登记人"></el-input>
          </el-form-item>
      ...
      <div class="tables">
        ...
        >
          ...
          <el-table-column width="200" sortable prop="customername" label="客户名称"></el-table-column>
          ...
          <el-table-column width="150" sortable prop="begindate" label="上关注名单时间"></el-table-column>
          <el-table-column width="200" sortable prop="relativeserialno" label="申请编号"></el-table-column>
          <el-table-column sortable prop="status1" label="状态"></el-table-column>
          <el-table-column sortable prop="inputuserid" label="登记人"></el-table-column>
          <el-table-column width="150" sortable prop="effectivedate" label="黑名单生效时间"></el-table-column>
          <el-table-column width="150" sortable prop="invaliddate" label="黑名单失效时间"></el-table-column>
          <el-table-column width="200" sortable prop="updatedate" label="更新时间"></el-table-column>
      ...
      <!-- <el-checkbox
        class="b_check"
        @change="toggleSelection(for_, checkFlag)"
      >全选</el-checkbox> -->
    </div>
    <!-- 分页 -->
    ...
    <!-- 引入组件 -->
    <addWatchLists :refreshList="refreshList" v-if="alert_" @clsoe_windowAlert="close_1"/>
...
import addWatchLists from "./addWatchLists"; // 新增组件
import introductionList from "./introductionList"; // 批量导入组件
import failedPopover from "./failedPopover"; // 批量导入模板有误组件
import failureList from "./failureList"; // 批量失效组件
import hint from "./hint"; // 批量失效提示组件
import xq from "../watch-list-management/details_alert/ListManagement"; // 详情组件
import { fqzApi } from "../../anti-fraud/js/server"; // 接口
...
export default {
  data() {
    return {
      ...
      rules: {
        // certificateTypeCode: [{ message: "请选择证件类型", trigger: "change" }],
        // certificateNum: [
        //   { required: true, message: "请先选择证件类型", trigger: "change" }
        // ],
        certificateNum01: [
      ...
      // controls: false, // 全选按钮默认不勾选
      // whetherSelect: true, // 全选按钮默认不可点
      alert_: false, // 新增关注名单弹窗
      import_s: false, // 批量导入
  ...
  methods: {
    ...
    saveText_s(file) {
      ...
      data.append("customertype", "2"); // 客户类型
      ...
      this.$MyFetch
        ...
        .then((data = {}) => {
          ...
          for (var i = 0; i < this.list_input.length; i++) {
            if (this.list.certtype === this.list_input[i].id) {
    ...
    clear() {
      ...
      this.ruleForm.certificateNum01 = "";
      this.ruleForm.certificateTypeCode = "";
      this.ruleForm.qzxz = "";
      this.ruleForm.zt = "";
      this.ruleForm.djr = "";
      ...
      if (
        ...
        this.$MyFetch
          ...
          .then((data = {}) => {
            ...
            //   // this.controls = true;
            //   // this.whetherSelect = true;
            // } else {
            //   // this.whetherSelect = false;
            // }
            console.log(data);
            console.log(this.ruleForm["certificateNum" + this.carType]);
    ...
    get_data() {
      let data = {
        codenoList: ["CertType", "CheatOrNot", "InvalidOReffective"]
      };
