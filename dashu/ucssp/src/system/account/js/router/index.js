module.exports = {
  ...
  children: [
    ...
    {
      name: 'f2f-remote-config',
      path: 'f2f-remote-config',
      component: resolve => require(['@system/account/f2f-remote-config'], resolve)
    },
    {
      name: 'auto-account',
      path: 'auto-account',
      component: resolve => require(['@system/account/auto-account'], resolve)
    }
  ]
};
