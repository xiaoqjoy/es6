<template>
  <div class="insurance-manage">
    <div class="tab-home">
      <el-tabs v-model="activeName" @tab-click="handleClick" class="ata">
        <el-tab-pane label="审批中" name="insurance-approving"></el-tab-pane>
        <el-tab-pane label="已处理" name="insurance-disposed"></el-tab-pane>
      </el-tabs>
    </div>
    <router-view/>
  </div>
...
export default {
  ...
  data() {
    return {
      activeName: "insurance-approving"
    };
  },
