                ...
                <ul class="clearfix">
                  ...
                  <li class="f__right">
                    ...
                    <el-form-item prop="primaryProductCode">
                      <el-select v-model="ruleForm.primaryProductCode" multiple filterable clearable collapse-tags placeholder="请选择" @change="primaryProductChange">
    ...
    save() {
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          ...
          // 新增->保存按钮
          // console.log(this.primaryProductName);
          let req = {
            orgId: this.ruleForm.orgId,
            orgName: this.ruleForm.orgName,
            primaryProductName: this.primaryProductName.join(","),
          ...
          // console.log(req);
          let url =
            accountApi.bankCard_check_rule_maintain.saveBankCardCheckInfo;
      ...
      this.topBusinessType.map(value => {
        val.map(v => {
          if (value.codeValue === v) {
            this.primaryProductName.push(value.codeText);
          }
        });
      });
    },
