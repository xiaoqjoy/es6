              ...
              <div class="form__block bg__white border__radius-5" >
                ...
                <div class="dialog-box__form__group">
                  ...
                  <el-form-item label="证件号码"
                                prop="certificateNum">
                    <el-input v-model="form.certificateNum" :disabled="!!hasSubmit"></el-input>
                  </el-form-item>
                  ...
                  <el-form-item label="分机" prop="houseBranchNum">
                    <el-input v-model="form.houseBranchNum" :disabled="!!hasSubmit" maxlength="10"></el-input>
                  </el-form-item>
                  <el-form-item label="家庭住址" prop="houseAddress">
                    <el-input v-model="form.houseAddress" :disabled="!!hasSubmit" maxlength="50"></el-input>
                  </el-form-item>
                </div>
              </div>
              <div class="form__block bg__white border__radius-5" >
                ...
                <div class="dialog-box__form__group mgtop">
                  <el-form-item label="单位联系人姓名" prop="workContractName" >
                    <el-input v-model="form.workContractName" :disabled="!!hasSubmit" maxlength="30"></el-input>
                  </el-form-item>
                  <el-form-item label="单位名称" prop="workplaceName" >
                    <el-input v-model="form.workplaceName" :disabled="!!hasSubmit" maxlength="100"></el-input>
                  </el-form-item>
                  ...
                  <el-form-item label="单位分机" prop="workBranchNum">
                    <el-input v-model="form.workBranchNum" :disabled="!!hasSubmit" maxlength="10"></el-input>
                  </el-form-item>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          workplaceName: [
            { required: true, message: '请填写单位名', trigger: 'blur' },
    ...
    methods: {
      ...
      addGuaranteeApi(data) {
        return new Promise((resolve, reject) => {
          this.$MyFetch.post(spareApi.solving.completeInfo.completeProduct.addGuarantee, data)
            .then((data = {}) => {
              resolve(data);
            })
            .catch(err => {
      ...
      editGuaranteeApi(data) {
        return new Promise((resolve, reject) => {
          this.$MyFetch.post(spareApi.solving.completeInfo.completeProduct.editGuarantee, data)
            .then((data = {}) => {
              resolve(data);
            })
            .catch(err => {
      ...
      checkCard(rule, value, callback) {
        if (this.form.certificateTypeCode === this.dCode.certificateTypeCode.ID) {
