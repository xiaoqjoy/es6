  ...
  <div class="drop_loan">
    ...
    <div class="dialog-box">
      <div class="dialog-box__top">
        <div class="title_type"><span>是否删除记录编号「</span><span>{{compile.recordNum}}</span><span>」的模型？</span></div>
...
export default {
  ...
  methods: {
    close() {
      this.$emit("clsoe_windowAlert_d");
    },
    finish() {
      console.log("wancheng");
      let url = configApi.audit_delete;
      let ids = [];
      ids.push(this.compile.id);
      let data = {
        ids
      };
      console.log(data);
