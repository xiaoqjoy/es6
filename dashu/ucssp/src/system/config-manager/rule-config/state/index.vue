  ...
  <div class="drop_loan">
    ...
    <div class="dialog-box">
      ...
      <div class="form__button no">
        <el-button class="button" type="primary" @click="close">否</el-button>
      </div>
      <div class="form__button yes">
        <el-button type="primary" @click="save">是</el-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  props: ["form_a", "orgForm_a", "ruleForm"],
  data() {
    return {};
  },
  methods: {
