...
const configApi = {
  ...
  risklevel: xx + "/apr/businessList/risklevel/list", // 模型角色
  ...
  configSave: xx + '/apr/config/operationConfig/{configType}/threeLevel/save',
  getOptionList: xx + '/apr/config/operationConfig/{configType}/oneLevelList',
  getThreeList: xx + '/apr/config/operationConfig/{configType}/threeList',
  // 审计进件规则配置
  ...
  // 查询双级配置联动列表
  level_relative: xx + "/apr/config/operationConfig", // 后续补充/{configType}/levelList

  // 降额原因页api
  derate_base: xx + "/apr/config/operationConfig" // 后续补充
};
