...
if (process.env.NODE_ENV !== 'production') {
  ...
  // host = 'http://10.21.0.99:8103'; // 开发环境
  // host = "/api/cpms"; // 测试环境
...
const baseApi = {
  ...
  getContractList: host + "/f2f/counter/product-info/contracts", // 726需求，查询产品需打印的合同列表
  ...
  callQueueNoForF2F: host + "/v1/queue/f2f/counter/callQueueNo", // 叫号 5.31优化项，将叫号接口拆成两个，分别是柜面和远程
  ...
  centerPrinters: host + "/f2f/counter/", // 查询处理中心打印机列表
  ...
  exportRepayment: host + '/f2f/{f2fType}/exportRepaymentTable',
  loanHistoryInfo: host + '/f2f/loanHistory/info/{applicationId}',
  loanAttention: host + '/f2f/loanAttention/info/{applicationId}'
};
const easyLoan = {
