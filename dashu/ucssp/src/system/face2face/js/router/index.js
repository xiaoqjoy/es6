  ...
  children: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: resolve =>
            require([
              "@system/face2face/face2face-undisposed/product_list/index"
            ], resolve)
        },
        {
          name: "product-info",
    ...
    },
    {
      ...
      path: "face-2-face-new/:applicationId/:customerName/:resignInd",
      component: resolve =>
        require(["@system/face2face/face2face-undisposed/visa_new/index"], resolve),
      props: { default: true }
    },
    {
      name: 'face2face-preview',
      path: 'face2face-preview',
      component: resolve => require(['@system/face2face/face2face-preview/index'], resolve)
    }
  ]
};
