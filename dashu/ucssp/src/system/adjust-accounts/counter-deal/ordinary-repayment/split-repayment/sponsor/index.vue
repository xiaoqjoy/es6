<template>
    <div class="sponsor">
        ...
        <!-- 新增单笔还款 -->
        <addPriorMatch v-if="alert_" @clsoe_windowAlert='close_1' @SingleRepayment='addSingleRepayment'></addPriorMatch>
        <!-- 明细 -->
...
export default {
    ...
    methods: {
        ...
        // 新增完后调用一般还款查询总单接口
        addSingleRepayment(res, current) {
            res = res || {
                "phase_no": "0010",
                "flow_no": "splitPayFlow"
            };
            current = this.pageConfig.currentPage || 1;
            let url = counterDealApi.SingleRepayment + "?current=" + current + "&size=10";
            this.$MyFetch.post(url, res)
            .then((data = {}) => {
                this.for_ = data.records;
        ...
        handleSelectionChange (data) {
            ...
            console.log(this.deleteData, this.submitData, 'deleteSumitData');
        },
