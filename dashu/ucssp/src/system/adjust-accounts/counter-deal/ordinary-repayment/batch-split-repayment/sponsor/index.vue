...
export default {
    ...
    methods: {
        ...
        // 文件下载保存
        batchSplitRepaymentFileSave(res) {
            return new Promise((resolve, reject) => {
                this.$MyFetch.post(counterDealApi.batchSplitRepaymentFileSave, res, {timeout: 120000})
                    .then((data = {}) => {
                        if (data.success) {
                            resolve(data);
                        } else {
        ...
        FileSaveFun() {
            ...
            this.batchSplitRepaymentFileSave(queryData)
                .then((data) => {
                   _that.reload();
