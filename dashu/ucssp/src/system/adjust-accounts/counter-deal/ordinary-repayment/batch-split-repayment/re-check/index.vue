            ...
            <el-table-column
             ...
             <el-table-column
                ...
                <template slot-scope="scope">
                    <el-popover trigger="hover" placement="top" v-if="scope.row.file_name">
                        <p class="ellipsis">
                            {{scope.row.file_name}}
                        </p>
                        <div slot="reference">
...
export default {
    ...
    methods: {
        ...
        // 单笔还款复核退回（支持批量/单笔）
        batchRepaymentReviewReturn(res) {
        ...
        affirm_submit_fun() {
            ...
            // 调用记账接口
            let submitData = {
                flowNo: "batchSplitPayFlow",
                relatedId: [this.deleteSubmitData.related_id]
            };
            console.log(submitData);
            this.batchRepaymentBookkeep(submitData)
                .then((data) => {
                    console.log("刷新");
                    this.reload();
                })
        ...
        affirm_delete_fun() {
            ...
            this.batchRepaymentReviewReturn(backData)
                .then((data) => {
                    console.log("刷新");
                    this.reload();
                })
        ...
        // 退回按钮
        retrun_fun() {
            if (!this.deleteSubmitData.related_id) {
