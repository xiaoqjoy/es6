...
<template>
  <div class="drop_loan">
            ...
            <div class="form__block bg__white border__radius-5" >
              ...
              <div class="info_show">
                <span class="info_item">
                  ...
                  <b class="info_right black_color">{{ businessCode }}</b>
                </span>
                <span class="info_item">
                  <i class="info_left">出账编号:&nbsp;</i>
                  <b class="info_right black_color">{{ importData.loan_no }}</b>
                </span>
                <span class="info_item">
                  <i class="info_left">期次:&nbsp;</i>
                  <b class="info_right black_color">{{ importData.sterm }}</b>
                </span>
                <span class="info_item">
                  <i class="info_left">应还日期:&nbsp;</i>
                  <b class="info_right black_color">{{ importData.pay_date }}</b>
                </span>
                <span class="info_item">
                  <i class="info_left">应还本金:&nbsp;</i>
                  <b class="info_right">{{ importData.pay_corp }}</b>
                </span>
                <span class="info_item">
                  <i class="info_left">应还利息:&nbsp;</i>
                  <b class="info_right">{{ importData.pay_inte }}</b>
                </span>
                <span class="info_item">
                  <i class="info_left">应还罚息:&nbsp;</i>
                  <b class="info_right">{{ importData.pay_fine }}</b>
                </span>
                <span class="info_item">
                  <i class="info_left">应还复利:&nbsp;</i>
                  <b class="info_right">{{ importData.pay_compound }}</b>
                </span>
                <span class="info_item">
                  <i class="info_left">应还代垫罚息:&nbsp;</i>
                  <b class="info_right">{{ importData.dd_pay_fine }}</b>
                </span>
                <span class="info_item">
                  <i class="info_left">应还代垫复利:&nbsp;</i>
                  <b class="info_right">{{ importData.dd_pay_compound }}</b>
                </span>
              </div>
              <el-form :model="writeInfo" :rules="rules" ref="writeInfo">
                ...
                <div class="select_box">
                  ...
                  <div class="select_item margin_r_60">
                    ...
                    <div class="select_input">
                      <el-form-item prop="ChanneCodeNo">
                        <el-select v-model="writeInfo.ChanneCodeNo" class="select_245" placeholder="记账渠道">
                  ...
                  <div class="select_item">
                    ...
                    <el-form-item prop="actualCorp">
                      <el-input v-model="writeInfo.actualCorp" placeholder="请填写"></el-input>
                    </el-form-item>
                  </div>
                  <!-- 实还利息 -->
                  <div class="select_item margin_r_60">
                    ...
                    <el-form-item prop="actualInte">
                      <el-input v-model="writeInfo.actualInte" placeholder="请填写"></el-input>
                    </el-form-item>
                  </div>
                  <!-- 实还罚息 -->
                  <div class="select_item margin_r_60">
                    ...
                    <el-form-item prop="actualFine">
                      <el-input v-model="writeInfo.actualFine" placeholder="请填写"></el-input>
                    </el-form-item>
                  </div>
                  <!-- 实还复利 -->
                  <div class="select_item">
                  ...
                  <div class="select_item margin_r_60">
                    ...
                    <el-form-item prop="ddActualFine">
                      <el-input v-model="writeInfo.ddActualFine" placeholder="请填写"></el-input>
                    </el-form-item>
                  </div>
                  <!-- 实还银行复利 -->
                  <div class="select_item">
                    ...
                    <el-form-item prop="ddActualCompound">
                      <el-input v-model="writeInfo.ddActualCompound" placeholder="请填写"></el-input>
                    </el-form-item>
                  </div>
                </div>
                <!-- 费用 -->
                <div :if="listMaps" class="cost" v-for="(infoItem, infoIndex) in writeInfo.listMaps" :key="infoIndex">
                  <div class="costItem">
                    <div class="costType">
                      <span>费用类型:&nbsp;&nbsp;</span><i>{{ infoItem.fee_type_name }}</i>
                    </div>
                    <div class="costMoney">
                      <span class="costMoney_item">
                        <i class="info_left">应还费用:&nbsp;</i>
                        <b class="info_right">{{ infoItem.pay_amount }}</b>
                      </span>
                      <span class="costMoney_item">
                        <i class="info_left">实还费用:</i>
                        <input type="text" placeholder="请填写" v-model="infoItem.actualAmount" value="0" @change="feeChange(infoItem.actualAmount, 'actualAmount'+infoIndex, infoItem.pay_amount)">
                        <span class="hintMsg" :ref="'actualAmount'+infoIndex"></span>
                      </span>
                    </div>
                    <div class="costMoney" v-show="infoItem.fee_type === '006'">
                      <span class="costMoney_item">
                        <i class="info_left">应还费用罚息:&nbsp;</i>
                        <b class="info_right">{{ infoItem.pay_fine }}</b>
                      </span>
                      <span class="costMoney_item">
                        <i class="info_left">实还费用罚息:</i>
                        <input type="text" placeholder="请填写" v-model="infoItem.actualFine" value="0" @change="feeChange(infoItem.actualFine, 'actualFine'+infoIndex, infoItem.pay_fine)">
                        <span class="hintMsg" :ref="'actualFine'+infoIndex"></span>
                      </span>
                    </div>
                  </div>
                </div>
    ...
    <!-- 引入单笔还款 组件 -->
    <importPriorMatch v-if="alert_2" @clsoe_windowAlert2='close_2' @importSendData='importSendData'></importPriorMatch>
  </div>
</template>
<script type="text/ecmascript-6">
import "@common/css/dialog";
import importPriorMatch from "../../sponsor/importPriorMatch/"; // 引入单笔还款
...
export default {
  ...
  nonNegative3: (actualAmount) => {
    ...
    // 渠道列表
      ...
      // 一般还款保存按钮接口
      SaveRepayment(res) {
        if (!res.transSerialNo) {
          this.$error("系统繁忙，请返回重新获取业务号。");
          return false;
        }
        return new Promise((resolve, reject) => {
