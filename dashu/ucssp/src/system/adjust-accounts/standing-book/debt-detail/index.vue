          ...
          <div class="content_border">
            ...
            <div class="content">
              <div class="contentA">
                ...
                <div class="contentItem">
                  <span class="contentItemTitle">是否已代偿:</span>
                  <span class="contentItemCon" v-html="detailList.common_flag"></span>
                </div>
                <div class="contentItem">
                  <span class="contentItemTitle">是否已理赔:</span>
                  <span class="contentItemCon" v-html="detailList.claim_flag"></span>
                </div>
              </div>
              <div class="contentA">
              ...
              <div class="contentA" style="border-bottom: none;">
                <div class="content_title">子账户信息</div>
                <el-table
                  :default-sort="{prop: 'date', order: 'descending'}"
                  :header-cell-style="{'font-size':'12px','text-align':'center','height':'38.9px','background':'#ececec'}"
                  ref="multipleTable"
                  ...
                  @selection-change="handleSelectionChange"
                >
                  <el-table-column prop="accountTypeName" label="账号类型"></el-table-column>
                  <el-table-column prop="subAccount" label="卡号"></el-table-column>
              ...
              <div class="contentA">
                ...
                <div class="table_box">
                  ...
                  >
                    ...
                    <el-table-column prop="trans_channel_name" label="扣款渠道"></el-table-column>
              ...
              <div class="contentA">
                ...
                <div class="table_box table_box_box">
                  ...
                  >
                    ...
                    <el-table-column prop="transChannelName" label="扣款渠道"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    subLoanRelative() {
      this.$MyFetch.post(checkingApi.subLoanRelative, {
        loanNo: this.$route.query.loan_no
      }).then((data) => {
        this.subLoanList = data;
      }).catch((err) => {
        this.$error(err.message);
      });
    },
