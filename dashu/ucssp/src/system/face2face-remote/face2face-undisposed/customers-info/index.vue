  ...
  <div class="complete-customer-info face2face-detail-style">
    <div class="dialog-box__middle-form">
      ...
      <div class="form__block bg__white border__radius-5" >
          ...
          <ic-info :showSpouse="false" :disabled="(isDetail || !openVideo) && icDisabled"
          :apiUrl="icInfo_url" :applicationId="applicationId"
          :isDetail="isDetail" :routerPath="'remote-ic-info-detail'" :taskNodeCode="'faceToFaceTask'">
        </ic-info>
      </div>
      <div class="form__block bg__white border__radius-5" >
          ...
          <div class="dialog-box__form__group margin-top__20">
            <div class="drop__select-box el-form-item__25">
              ...
              <button
                ...
                :class="{isactive:dropSelectShow3, disabled: isDetail || ydApproveMode2}"
                :disabled="isDetail || ydApproveMode2 || custMarketingInfo.custManagerInd || !openVideo">{{selectManagerChannel.userName}}<i class="icon el-select__caret el-input__icon el-icon-arrow-up"></i> </button>
            ...
            <el-form-item label="属地客服：" prop="custServiceId" class="el-form-item__25 width220" >
              <el-select clearable filterable v-model="custMarketingInfo.custServiceId" placeholder="请选择属地客服" :disabled="isDetail || !openVideo || ydApproveMode2 || localCustemService.length === 0">
...
export default {
  ...
  created() {
    ...
    this.getMultipleLibrary(this.selectArr, this.isDetail)
      .then(_data => {
  ...
  methods: {
    ...
    getAllInfo() {
      ...
      // 获取婚姻状况字典
      let marital = this.isDetail ? 'pf_marital_status_code' : 'marital_status_code';
      this.$getDictCode(marital, {getAll: this.isDetail}).then(res => {
    ...
    submit(_flag) {
      ...
      if (hasPass === 0) {
        ...
        //     this.basicInfo_saveApi(data, _flag);
        //   });
        //   return;
        // }
        this.basicInfo_saveApi(data, _flag);
    ...
    // 保存客户基本信息
    basicInfo_saveApi(data, _flag) {
      let loading = this.$loading({
          text: "",
          spinner: "",
          background: 'transparent'
        });
      this.$MyFetch.post(baseApi.saveCustomerInfo, data).then(() => {
        loading.close();
