    ...
    <div class="nav-content" v-if="dialogVisible">
      <div class="nav-content1" v-if="currentTab === 0">
        <div class="check-tabs">
          ...
          <div class="check-tabs-btn remote-check-tabs-btn">
            <el-button type="text" style="font-size: 12px" @click="$showImage(applicationId, '远程面签', {ReadOnly: '0'})">影像资料</el-button>
...
export default {
  ...
  methods: {
    ...
    openFn() {
      ...
      // this.toRouter("remote-disposed-customers-info");
    ...
    //   // console.log(this.$route.name); // 判断"remote-f2f"和"face2face-remote-disposed"
    //   if (this.$route.name.indexOf("remote-f2f") > -1) {
    //     name = "remote-f2f-" + name;
    //   }
...
<style lang="less">
  .check-tabs-btn.remote-check-tabs-btn {
    > div {
      > ul.hover_down {
        top: 15px;
      }
