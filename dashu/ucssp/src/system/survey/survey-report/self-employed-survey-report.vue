          ...
          <div class="salaried">
            ...
            <input v-model="reportType" type="radio" name="report" value="2" id="salaried" @change="changeReportType(2)">
              ...
              <el-select v-model="svyBossReport.legalRelationship" placeholder="请选择">
						...
						<el-form-item label="申请人占股（%）" prop="applicantStocks" class="width245">
              ...
              <el-select v-model="svyBossReport.businessPlace" placeholder="请选择" :disabled="!fieldConfig.business_place.statusInd">
				...
				<div class="card_box">
					...
					<div class="card_item_box items_padding_top20">
						...
						<el-form-item label="上游企业类型" prop="upEnterpriseType" class="width245">
						...
						<el-form-item label="下游企业类型" prop="downEnterpriseType" class="width245">
                ...
                <el-option v-for="item in fieldConfig.down_enterprise_payment_method.children" :key="item.sortNum" :label="item.itemDesc" :value="item.itemCode"></el-option>
						...
						<el-form-item label="账期（天）" prop="downEnterprisePaymentDays" class="width245">
							<el-input v-model="svyBossReport.downEnterprisePaymentDays" placeholder="请填写" maxlength="100"></el-input>
						</el-form-item>
					</div>
				</div>
				<div class="card_box">
  ...
  methods: {
    ...
    initData() {
      ...
      if (!this.custInfo.surveyTypeST01) {
        this.$set(this.rules, 'operateTruth', []);
      }
    },
    setHiddenRisk(val) {
      for (let x of val) {
    ...
    previewReport() {
      this.validReport().then(() => {
		...
		// 保存报告
		saveReport() {
      console.log(this.svyBossReport, '保存的东西');
      this.validReport().then(() => {
        this.setHouseAndCar();
        this.reportRequest.carInfoList = this.carInfoList;
        this.reportRequest.estateInfoList = this.estateInfoList;
