  ...
  <div>
    <div class="report_content" v-if="svyBossReport">
      <div class="card_box">
        ...
        <div class="card_item_box items_padding10">
          <div class="card_content"><span class="card_content_title">申请编号：</span><span class="card_content_font">{{svyBossReport.applicationId}}</span></div>
      ...
      <div class="card_box">
        ...
        <ul class="card_item_box items_padding10 text_left">
          ...
          <li class="card_item">
            ...
            <div class="card_item_content"><span class="card_content_title">调查经理：</span><span class="card_content_font">{{svyBossReport.surveyManagerName}}</span></div>
            <div class="card_item_content"><span class="card_content_title">调查主管：</span><span class="card_content_font">{{svyBossReport.surveyDirectorName}}</span></div>
            <div class="card_item_content"><span class="card_content_title">调查主管复核意见：</span><span class="card_content_font">{{svyReport.checkRecordList[0].checkOpinion}}</span></div>
          </li>
        </ul>
      </div>
    ...
    <div class="report_content" v-if="svyStaffReport">
      <div class="card_box">
        <div class="card_title">基本信息</div>
        <div class="card_item_box items_padding10">
          <div class="card_content"><span class="card_content_title">申请编号：</span><span class="card_content_font">{{svyStaffReport.applicationId}}</span></div>
          ...
          <div class="card_content"><span class="card_content_title">婚姻状况：</span><span class="card_content_font">{{setReportContent(svyStaffReport.maritalStatus, marital_status)}}</span></div>
          ...
          <div class="card_content"><span class="card_content_title">配偶是否知晓贷款：</span><span class="card_content_font">{{svyStaffReport.spouseKnowLoanInd ? '是' : '否'}}</span></div>
        </div>
      </div>
      ...
      <div class="card_box">
        ...
        <ul class="card_item_box items_padding10 text_left">
          ...
          <li class="card_item">
            ...
            <div class="card_item_content"><span class="card_content_title">调查经理：</span><span class="card_content_font">{{svyStaffReport.surveyManagerName}}</span></div>
            <div class="card_item_content"><span class="card_content_title">调查主管：</span><span class="card_content_font">{{svyStaffReport.surveyDirectorName}}</span></div>
            <div class="card_item_content"><span class="card_content_title">调查主管复核意见：</span><span class="card_content_font">{{svyReport.checkRecordList[0].checkOpinion}}</span></div>
          </li>
        </ul>
      </div>
...
export default {
  ...
  created() {
    ...
    this.svyReport.checkRecordList = this.reportData.checkRecordList;
