<template>
  <div>
    <div class="audit_box" id="audit_box">
        ...
        <div class="content">
          ...
          <div class="clearfloat content_btn" v-if="isShowInfo">
            <div class="tail_btn">
              ...
              <el-button type="primary" style="width:140px" @click="doSend" :disabled="clicked">预约提交</el-button>
      ...
      <survey-detail :insertNavBar="insertNavBar" @setReserveInfo="setReserveInfo" :audit-top="auditTop" ref="surveyDeatil"></survey-detail>
...
import { deepClone, reserveStatusConversion, surveyMixin } from './../../../js/utils.js';
      ...
      this.$MyFetch.post(surveyApi.reserveSave, this.surveyReserveInfoRequest).then(data => {
        if (data) {
          ...
          this.$MyFetch.get(surveyApi.surveyTaskDetails9 + this.surveyId).then((data = {}) => {
            this.setReserveInfo(data.surveyReserveInfo);
            this.clicked = false;
          }).catch((err) => {
            this.$error(err.message);
            this.clicked = false;
