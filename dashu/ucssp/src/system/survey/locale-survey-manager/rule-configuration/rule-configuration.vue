    ...
    <el-dialog class="dialog rule-dialog" title="调整" :visible.sync="dialogVisible" :before-close="handleClose" width="700px" center>
      <el-form class="search" :inline="true" :model="configInfo" :rules="configRule" ref="configInfo" label-position="top">
        <div class="dialog_con">
          ...
          <div class="top_conten"><span class="top_conten_title">所属面签中心：</span><span class="top_content_font">{{configInfo.serviceNameNew}}</span></div>
        </div>
        ...
        <div class="dialog_city_picker">
          ...
          <el-cascader class="width246" placeholder="请选择" v-model="selectedCity" :options="provinceList" :separator="null" @change="checkedAreaAddress"></el-cascader>
        </div>
      </el-form>
      <div class="checkbox_group">
        <div class="checkbox_group_title">区域:</div>
