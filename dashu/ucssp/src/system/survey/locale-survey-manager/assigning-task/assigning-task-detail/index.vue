  ...
  <div>
    <div class="audit_box" id="audit_box">
      <div class="audit_top" id="audit_top" ref="auditTop">
        <div class="backAudit">
          <router-link to="/system/survey/locale-survey-manager/assigning-task">
            <span class="blue_font bold">待分配任务</span>
          </router-link>
          <span class="el-icon-arrow-left"></span>
          <span class="black_font">分配</span>
        </div>
        <div class="content">
          <div class="content_head_title" :class="{'head_border_bottom' : isShowInfo}">任务分配<div class="btn_select" :class="{'btn_select_clicked' : isShowInfo}" @click="showInfo"></div> </div>
          <div v-if="isShowInfo">
      ...
      <survey-detail :insertNavBar="insertNavBar" :audit-top="auditTop" ref="surveyDeatil"></survey-detail>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    sureDistribution() {
      ...
      this.checkedRow.surveyStatus = 'surveyAllocatTask';
