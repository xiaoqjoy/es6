...
if (process.env.NODE_ENV !== 'production') {
  ...
  // host = 'http://dsapp18.intuat.dsfdc.com/h5/api/cpms'; // uat
  // host = 'http://dsapp135.sit.dashuf.com/h5/api/cpms'; // sit3
  // host = 'http://10.3.114.217:8080';
  host = fileCos.getHost()[1];
  host3 = fileCos.getHost()[0];
}
const surveyApi = {
  saveProductRemark: host + '/survey/task/productRemark/save',
  ...
  getinterface: host + "/survey/task/surveyLast30DayReport/get/",
  abnormalAdd: host + '/survey/config/abnormal/add',
  abnormalUpdate: host + '/survey/config/dict/update',
  queryAbnormal: host + '/survey/config/dict/abnormal' // 查询调查复核异常原因配置
};
// 审计审批模块数据来源
const aprAudApi = {
