let fileCos = {
  getHost() {
    // return ['api', 'api/cpms'];
     return ['/sit3/api', '/sit3/api/cpms', '/sit3/api/caes', '/sit3/api/bdcs'];
    // return ['/sit6/api', '/sit6/api/cpms', '/sit6/api/caes', '/sit6/api/bdcs'];
    // return ['/sit3/api', 'http://10.21.0.198:8080'];
    // return ['http://10.21.3.153:8080', 'http://10.21.3.153:8080'];
    // return ['/dev1/api', '/dev1/api/cpms'];
  },
  getCos() {
