...
gulp.task('zip', function() {
  return gulp.src('dist/wantong-xdt/**', {base: './dist/'})
  .pipe(zip('wantong-xdt.zip'))
  .pipe(gulp.dest('dist'));
});

gulp.task('txt', function() {
  return gulp.src('src/*.txt')
  .pipe(gulp.dest('dist/wantong-xdt'));
});
...
gulp.task('deploy195', function() {
  ...
  .pipe(ssh.dest('/data/www/wantong-xdt'));
});
