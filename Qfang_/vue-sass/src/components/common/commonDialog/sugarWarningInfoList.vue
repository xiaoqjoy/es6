<template>
  <div class="sugarWarningInfo tac" v-show="sugarWarningTableShow">
    ...
    <el-table :data="tableData" :row-class-name="tableRowClassName" @row-click="clickRow">
      <el-table-column prop="patientName" label="姓名" width="70" align="center">
      </el-table-column>
      <el-table-column prop="diabetesType" label="糖尿病类型" width="120" align="center">
      </el-table-column>
      <el-table-column prop="sugarTestTime" label="时间" width="110" align="center">
      </el-table-column>
      <el-table-column prop="timeType" label="时间段" width="70" align="center">
      </el-table-column>
      <el-table-column prop="sugar" label="血糖值" width="70" align="center">
      </el-table-column>
    </el-table>
...
<style scoped lang="less">
  ...
  .sugarWarningInfo .el-table td,
  .sugarWarningInfo .el-table th {
    padding: 5px 0;
  }
  .sugarWarningInfo tbody tr {
    cursor: pointer;
  }
</style>
<style type="text/css">
.sugarWarningInfo .el-table tr td {
    cursor: pointer;
  }  
