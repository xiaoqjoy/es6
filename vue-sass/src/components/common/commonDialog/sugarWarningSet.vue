<template>
  <div class="sugarWarningSetBox" v-show="dialogVisible">
    <el-dialog title="血糖预警设置" :visible.sync="dialogVisible" width="660px" :close-on-click-modal="false" :before-close="handleClose">
      <div class="warningSetContentBox clearfix">
        <div class="contentLeft floatLeft">
          <div class="switchBox clearfix">
            ...
            <el-switch class="switch" v-model="switchDialog" active-color="#13BB8E" inactive-color="#B2B8CD" active-text="ON" inactive-text="OFF" @change="sugarDialogChange">
            </el-switch>
          </div>
          <div class="setvalueBox">
            <div class="item colorBlack">
              ...
              <span class="ml">mmol/L</span>
              <span>进行预警</span>
            </div>
            <div class="colorRed heigh20" ><span v-show="warnMessageList[0]">最低值输入范围0.1~3.9</span></div>
            <div class="item colorBlack">
              <span>高于</span>
            ...
            <div class="colorRed heigh20" ><span v-show="warnMessageList[1]">最高值输入范围7.0~33.3</span></div>
        ...
        <div class="contentRight floatRight">
          <div class="switchBox clearfix">
            ...
            <el-switch class="switch" v-model="switchShortMessage" active-color="#13BB8E" inactive-color="#B2B8CD" active-text="ON" inactive-text="OFF" @change="sugarshortMessageChange">
            </el-switch>
          </div>
          <div class="setvalueBox">
            <div class="item colorBlack">
            ...
            <div class="colorRed heigh20" ><span v-show="warnMessageList[2]">最低值输入范围0.1~3.9</span></div>
            <div class="item colorBlack">
              <span>高于</span>
            ...
            <div class="colorRed heigh20" ><span v-show="warnMessageList[3]">最高值输入范围15.0~33.3</span></div>
  ...
  export default {
    ...
    methods: {
      ...
      validValueSet(index, minvalue, maxvalue) {
        // index , 第几个输入框
        let val = this.inputValueList[index];
        if (!!val && (val * 1 < minvalue || val * 1 > maxvalue)) {
      ...
      setSugarWarning() {
        ...
        let data = [{
            minValue: this.inputValueList[0],
            maxValue: this.inputValueList[1],
            type: 1,
            status: !this.dialogInputDisable ? '1' : '2',
            scope: this.scopeId,
            isUser: this.isUser,
            id: this.idDialog,
          ...
          {
            minValue: this.inputValueList[2],
            maxValue: this.inputValueList[3],
            type: 2,
            status: !this.dialogshortMessageDisable ? '1' : '2',
            scope: this.scopeId,
            isUser: this.isUser,
            id: this.idShortMessage,
            createUserId: this.createUserId
          }
        ];
        if (!value1 && !value2 && !value3 && !value4) {
          ...
          data.forEach((item, index) => {
            vm.$api.setSugarWarningValue(item, res => {
