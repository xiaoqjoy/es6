<template>
  <div>
    ...
    <el-table :data="tableData" border row-key="id" :height="tableHeight">
      ...
      <el-table-column prop="code" label="跟单员" align="center"></el-table-column>
      <el-table-column prop="code" label="查询征信" align="center"></el-table-column>
      <el-table-column prop="code" label="征信专员" align="center"></el-table-column>
      <el-table-column prop="code" label="赎楼员" align="center"></el-table-column>
      ...
      <el-table-column class-name="table-operate-btn" label="操作" align="center" min-width="160">
        <template slot-scope="scope">
          <span type="text" @click="showAddFlow(Object.assign(scope.row, {operateType:'edit'}))">编辑</span>
