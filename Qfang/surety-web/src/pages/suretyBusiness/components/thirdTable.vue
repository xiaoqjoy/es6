<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="name" label="客户经理" align="center"></el-table-column>
      <el-table-column prop="code" label="卖家" align="center"></el-table-column>
      <el-table-column prop="name" label="买家" align="center"></el-table-column>
      <el-table-column prop="code" label="分配日期" align="center"></el-table-column>
      <el-table-column prop="code" label="计划办理日期" align="center"></el-table-column>
      <el-table-column prop="code" label="实际办理日期" align="center"></el-table-column>
      <el-table-column prop="code" label="办理进度" align="center"></el-table-column>
      <el-table-column class-name="table-operate-btn" label="操作" align="center" min-width="160">
        <template slot-scope="scope">
          <span @click="showAddFlow(scope.row)">办理</span>
        </template>
      </el-table-column>
    </el-table>
  </div>
