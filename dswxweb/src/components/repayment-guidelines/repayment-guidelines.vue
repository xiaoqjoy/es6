...
export default {
  ...
  data () {
    return {
      // 还款操作指引接口
      URL: `${laappApi.reimbursementGuidelines}${"?"}${"productId="}${JSON.parse(localStorage.getItem("incorrect"))}`,
      // ‘取消’图片
